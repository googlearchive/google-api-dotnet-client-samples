    ...
    public static class PromptingClientCredentials
    {
        ...
        private static FileInfo CredentialsFile {
            get {
                ...
                string filePath =
                    Path.Combine(Path.Combine(applicationDate, ApplicationFolderName), ClientCredentialsFileName);
        ...
        public static SimpleClientCredentials CreateSimpleClientCredentials() {
        ...
        public static FullClientCredentials CreateFullClientCredentials() {
