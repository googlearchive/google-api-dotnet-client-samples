...
namespace Google.Apis.Fusiontables.v1 {
    ...
    public partial class FusiontablesService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"etag\":\"\\\"oZqOFf-aKzMvpID-BwBAFJLe7Pk/vVubBad" +
            "fD3bw-MV51jLEbtO-Nh0\\\"\",\"discoveryVersion\":\"v1\",\"id\":\"fusiontables:v1\",\"name\":\"f" +
            ...
            ",\"maxSize\":\"100MB\",\"protocols\":{\"simple\":{\"multipart\":true,\"path\":\"/upload/fusio" +
            "ntables/v1/tables/{tableId}/import\"},\"resumable\":{\"multipart\":true,\"path\":\"/resu" +
            "mable/upload/fusiontables/v1/tables/{tableId}/import\"}}}},\"insert\":{\"id\":\"fusion" +
            "tables.table.insert\",\"path\":\"tables\",\"httpMethod\":\"POST\",\"description\":\"Creates " +
            "a new table.\",\"request\":{\"$ref\":\"Table\"},\"response\":{\"$ref\":\"Table\"},\"scopes\":[\"" +
            "https://www.googleapis.com/auth/fusiontables\"]},\"list\":{\"id\":\"fusiontables.table" +
            ".list\",\"path\":\"tables\",\"httpMethod\":\"GET\",\"description\":\"Retrieves a list of tab" +
            "les a user owns.\",\"parameters\":{\"maxResults\":{\"type\":\"integer\",\"description\":\"Ma" +
            "ximum number of styles to return. Optional. Default is 5.\",\"format\":\"uint32\",\"mi" +
            "nimum\":\"0\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"Conti" +
            "nuation token specifying which result page to return. Optional.\",\"location\":\"que" +
            "ry\"}},\"response\":{\"$ref\":\"TableList\"},\"scopes\":[\"https://www.googleapis.com/auth" +
            "/fusiontables\",\"https://www.googleapis.com/auth/fusiontables.readonly\"]},\"patch\"" +
            ":{\"id\":\"fusiontables.table.patch\",\"path\":\"tables/{tableId}\",\"httpMethod\":\"PATCH\"" +
            ...
            "semantics.\",\"parameters\":{\"replaceViewDefinition\":{\"type\":\"boolean\",\"description" +
            "\":\"Should the view definition also be updated? The specified view definition rep" +
            "laces the existing one. Only a view can be updated with a new definition.\",\"loca" +
            "tion\":\"query\"},\"tableId\":{\"type\":\"string\",\"description\":\"ID of the table that is" +
            " being updated.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"tableId\"" +
            "],\"request\":{\"$ref\":\"Table\"},\"response\":{\"$ref\":\"Table\"},\"scopes\":[\"https://www." +
            "googleapis.com/auth/fusiontables\"]},\"update\":{\"id\":\"fusiontables.table.update\",\"" +
            "path\":\"tables/{tableId}\",\"httpMethod\":\"PUT\",\"description\":\"Updates an existing t" +
            "able. Unless explicitly requested, only the name, description, and attribution w" +
            "ill be updated.\",\"parameters\":{\"replaceViewDefinition\":{\"type\":\"boolean\",\"descri" +
            "ption\":\"Should the view definition also be updated? The specified view definitio" +
            "n replaces the existing one. Only a view can be updated with a new definition.\"," +
            "\"location\":\"query\"},\"tableId\":{\"type\":\"string\",\"description\":\"ID of the table th" +
            "at is being updated.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"tab" +
            "leId\"],\"request\":{\"$ref\":\"Table\"},\"response\":{\"$ref\":\"Table\"},\"scopes\":[\"https:/" +
            "/www.googleapis.com/auth/fusiontables\"]}}},\"template\":{\"methods\":{\"delete\":{\"id\"" +
            ":\"fusiontables.template.delete\",\"path\":\"tables/{tableId}/templates/{templateId}\"" +
            ",\"httpMethod\":\"DELETE\",\"description\":\"Deletes a template\",\"parameters\":{\"tableId" +
            "\":{\"type\":\"string\",\"description\":\"Table from which the template is being deleted" +
            "\",\"required\":true,\"location\":\"path\"},\"templateId\":{\"type\":\"integer\",\"description" +
            "\":\"Identifier for the template which is being deleted\",\"required\":true,\"format\":" +
            "\"int32\",\"location\":\"path\"}},\"parameterOrder\":[\"tableId\",\"templateId\"],\"scopes\":[" +
            "\"https://www.googleapis.com/auth/fusiontables\"]},\"get\":{\"id\":\"fusiontables.templ" +
            "ate.get\",\"path\":\"tables/{tableId}/templates/{templateId}\",\"httpMethod\":\"GET\",\"de" +
            "scription\":\"Retrieves a specific template by its id\",\"parameters\":{\"tableId\":{\"t" +
            "ype\":\"string\",\"description\":\"Table to which the template belongs\",\"required\":tru" +
            "e,\"location\":\"path\"},\"templateId\":{\"type\":\"integer\",\"description\":\"Identifier fo" +
            "r the template that is being requested\",\"required\":true,\"format\":\"int32\",\"locati" +
            "on\":\"path\"}},\"parameterOrder\":[\"tableId\",\"templateId\"],\"response\":{\"$ref\":\"Templ" +
            "ate\"},\"scopes\":[\"https://www.googleapis.com/auth/fusiontables\",\"https://www.goog" +
            "leapis.com/auth/fusiontables.readonly\"]},\"insert\":{\"id\":\"fusiontables.template.i" +
            "nsert\",\"path\":\"tables/{tableId}/templates\",\"httpMethod\":\"POST\",\"description\":\"Cr" +
            "eates a new template for the table.\",\"parameters\":{\"tableId\":{\"type\":\"string\",\"d" +
            "escription\":\"Table for which a new template is being created\",\"required\":true,\"l" +
            "ocation\":\"path\"}},\"parameterOrder\":[\"tableId\"],\"request\":{\"$ref\":\"Template\"},\"re" +
            "sponse\":{\"$ref\":\"Template\"},\"scopes\":[\"https://www.googleapis.com/auth/fusiontab" +
            "les\"]},\"list\":{\"id\":\"fusiontables.template.list\",\"path\":\"tables/{tableId}/templa" +
            "tes\",\"httpMethod\":\"GET\",\"description\":\"Retrieves a list of templates.\",\"paramete" +
            "rs\":{\"maxResults\":{\"type\":\"integer\",\"description\":\"Maximum number of templates t" +
            "o return. Optional. Default is 5.\",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"q" +
            "uery\"},\"pageToken\":{\"type\":\"string\",\"description\":\"Continuation token specifying" +
            " which results page to return. Optional.\",\"location\":\"query\"},\"tableId\":{\"type\":" +
            "\"string\",\"description\":\"Identifier for the table whose templates are being reque" +
            "sted\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"tableId\"],\"response" +
            "\":{\"$ref\":\"TemplateList\"},\"scopes\":[\"https://www.googleapis.com/auth/fusiontable" +
            "s\",\"https://www.googleapis.com/auth/fusiontables.readonly\"]},\"patch\":{\"id\":\"fusi" +
            "ontables.template.patch\",\"path\":\"tables/{tableId}/templates/{templateId}\",\"httpM" +
            "ethod\":\"PATCH\",\"description\":\"Updates an existing template. This method supports" +
            " patch semantics.\",\"parameters\":{\"tableId\":{\"type\":\"string\",\"description\":\"Table" +
            " to which the updated template belongs\",\"required\":true,\"location\":\"path\"},\"temp" +
            "lateId\":{\"type\":\"integer\",\"description\":\"Identifier for the template that is bei" +
            "ng updated\",\"required\":true,\"format\":\"int32\",\"location\":\"path\"}},\"parameterOrder" +
            "\":[\"tableId\",\"templateId\"],\"request\":{\"$ref\":\"Template\"},\"response\":{\"$ref\":\"Tem" +
            "plate\"},\"scopes\":[\"https://www.googleapis.com/auth/fusiontables\"]},\"update\":{\"id" +
            "\":\"fusiontables.template.update\",\"path\":\"tables/{tableId}/templates/{templateId}" +
            "\",\"httpMethod\":\"PUT\",\"description\":\"Updates an existing template\",\"parameters\":{" +
            "\"tableId\":{\"type\":\"string\",\"description\":\"Table to which the updated template be" +
            "longs\",\"required\":true,\"location\":\"path\"},\"templateId\":{\"type\":\"integer\",\"descri" +
            "ption\":\"Identifier for the template that is being updated\",\"required\":true,\"form" +
            "at\":\"int32\",\"location\":\"path\"}},\"parameterOrder\":[\"tableId\",\"templateId\"],\"reque" +
            "st\":{\"$ref\":\"Template\"},\"response\":{\"$ref\":\"Template\"},\"scopes\":[\"https://www.go" +
            "ogleapis.com/auth/fusiontables\"]}}}}}";
