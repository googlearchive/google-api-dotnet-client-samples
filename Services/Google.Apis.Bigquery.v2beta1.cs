...
namespace Google.Apis.Bigquery.v2beta1 {
    ...
    public partial class BigqueryService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"discoveryVersion\":\"v1\",\"id\":\"bigquery:v2beta" +
            "1\",\"name\":\"bigquery\",\"version\":\"v2beta1\",\"revision\":\"20120614\",\"title\":\"BigQuery" +
            ...
            "\"https://www.googleapis.com/auth/bigquery\"],\"supportsMediaUpload\":true,\"mediaUpl" +
            "oad\":{\"accept\":[\"application/octet-stream\"],\"protocols\":{\"simple\":{\"multipart\":t" +
            "rue,\"path\":\"/upload/bigquery/v2beta1/projects/{projectId}/jobs\"},\"resumable\":{\"m" +
            "ultipart\":true,\"path\":\"/resumable/upload/bigquery/v2beta1/projects/{projectId}/j" +
            "obs\"}}}},\"list\":{\"id\":\"bigquery.jobs.list\",\"path\":\"projects/{projectId}/jobs\",\"h" +
            "ttpMethod\":\"GET\",\"parameters\":{\"allUsers\":{\"type\":\"boolean\",\"description\":\"Wheth" +
            "er to display jobs owned by all users in the project\",\"location\":\"query\"},\"maxRe" +
            "sults\":{\"type\":\"integer\",\"description\":\"maximum number of results to return\",\"fo" +
            "rmat\":\"uint32\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"location\":\"quer" +
            "y\"},\"projectId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"},\"projection\"" +
            ":{\"type\":\"string\",\"description\":\"Restrict information returned to a set of selec" +
            "ted fields.\",\"enum\":[\"full\",\"minimal\"],\"enumDescriptions\":[\"Includes all job dat" +
            "a.\",\"Does not include the job configuration.\"],\"location\":\"query\"},\"startIndex\":" +
            "{\"type\":\"integer\",\"description\":\"start index for paginated results\",\"format\":\"ui" +
            "nt32\",\"location\":\"query\"},\"stateFilter\":{\"type\":\"string\",\"description\":\"filter f" +
            "or job state\",\"enum\":[\"done\",\"pending\",\"running\"],\"enumDescriptions\":[\"finished " +
            "jobs\",\"pending jobs\",\"running jobs\"],\"repeated\":true,\"location\":\"query\"}},\"param" +
            "eterOrder\":[\"projectId\"],\"response\":{\"$ref\":\"JobList\"},\"scopes\":[\"https://www.go" +
            "ogleapis.com/auth/bigquery\"]},\"query\":{\"id\":\"bigquery.jobs.query\",\"path\":\"projec" +
            "ts/{projectId}/queries\",\"httpMethod\":\"POST\",\"parameters\":{\"projectId\":{\"type\":\"s" +
            "tring\",\"description\":\"project name billed for the query\",\"required\":true,\"locati" +
            "on\":\"path\"}},\"parameterOrder\":[\"projectId\"],\"request\":{\"$ref\":\"JobQueryRequest\"}" +
            ",\"response\":{\"$ref\":\"QueryResults\"},\"scopes\":[\"https://www.googleapis.com/auth/b" +
            "igquery\"]},\"stop\":{\"id\":\"bigquery.jobs.stop\",\"path\":\"project/{projectId}/jobs/{j" +
            "obId}/stop\",\"httpMethod\":\"POST\",\"parameters\":{\"jobId\":{\"type\":\"string\",\"required" +
            "\":true,\"location\":\"path\"},\"projectId\":{\"type\":\"string\",\"required\":true,\"location" +
            "\":\"path\"}},\"parameterOrder\":[\"projectId\",\"jobId\"],\"response\":{\"$ref\":\"JobStopRes" +
            "ponse\"},\"scopes\":[\"https://www.googleapis.com/auth/bigquery\"]}}},\"projects\":{\"me" +
            "thods\":{\"list\":{\"id\":\"bigquery.projects.list\",\"path\":\"projects\",\"httpMethod\":\"GE" +
            "T\",\"parameters\":{\"maxResults\":{\"type\":\"integer\",\"format\":\"uint32\",\"location\":\"qu" +
            "ery\"},\"pageToken\":{\"type\":\"string\",\"location\":\"query\"}},\"response\":{\"$ref\":\"Proj" +
            "ectList\"},\"scopes\":[\"https://www.googleapis.com/auth/bigquery\"]}}},\"tabledata\":{" +
            "\"methods\":{\"list\":{\"id\":\"bigquery.tabledata.list\",\"path\":\"projects/{projectId}/d" +
            "atasets/{datasetId}/tables/{tableId}/data\",\"httpMethod\":\"GET\",\"parameters\":{\"dat" +
            "asetId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"},\"maxResults\":{\"type\"" +
            ":\"integer\",\"format\":\"uint32\",\"location\":\"query\"},\"projectId\":{\"type\":\"string\",\"r" +
            "equired\":true,\"location\":\"path\"},\"startIndex\":{\"type\":\"string\",\"format\":\"uint64\"" +
            ",\"location\":\"query\"},\"tableId\":{\"type\":\"string\",\"required\":true,\"location\":\"path" +
            "\"}},\"parameterOrder\":[\"projectId\",\"datasetId\",\"tableId\"],\"response\":{\"$ref\":\"Tab" +
            "leDataList\"},\"scopes\":[\"https://www.googleapis.com/auth/bigquery\"]}}},\"tables\":{" +
            "\"methods\":{\"delete\":{\"id\":\"bigquery.tables.delete\",\"path\":\"projects/{projectId}/" +
            "datasets/{datasetId}/tables/{tableId}\",\"httpMethod\":\"DELETE\",\"parameters\":{\"data" +
            "setId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"},\"projectId\":{\"type\":\"" +
            "string\",\"required\":true,\"location\":\"path\"},\"tableId\":{\"type\":\"string\",\"required\"" +
            ":true,\"location\":\"path\"}},\"parameterOrder\":[\"projectId\",\"datasetId\",\"tableId\"],\"" +
            "scopes\":[\"https://www.googleapis.com/auth/bigquery\"]},\"get\":{\"id\":\"bigquery.tabl" +
            "es.get\",\"path\":\"projects/{projectId}/datasets/{datasetId}/tables/{tableId}\",\"htt" +
            "pMethod\":\"GET\",\"parameters\":{\"datasetId\":{\"type\":\"string\",\"required\":true,\"locat" +
            "ion\":\"path\"},\"projectId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"},\"ta" +
            "bleId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"p" +
            "rojectId\",\"datasetId\",\"tableId\"],\"response\":{\"$ref\":\"Table\"},\"scopes\":[\"https://" +
            "www.googleapis.com/auth/bigquery\"]},\"insert\":{\"id\":\"bigquery.tables.insert\",\"pat" +
            "h\":\"projects/{projectId}/datasets/{datasetId}/tables\",\"httpMethod\":\"POST\",\"param" +
            "eters\":{\"datasetId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"},\"project" +
            "Id\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"proj" +
            "ectId\",\"datasetId\"],\"request\":{\"$ref\":\"Table\"},\"response\":{\"$ref\":\"Table\"},\"scop" +
            "es\":[\"https://www.googleapis.com/auth/bigquery\"]},\"list\":{\"id\":\"bigquery.tables." +
            "list\",\"path\":\"projects/{projectId}/datasets/{datasetId}/tables\",\"httpMethod\":\"GE" +
            "T\",\"parameters\":{\"datasetId\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"}" +
            ",\"maxResults\":{\"type\":\"integer\",\"format\":\"uint32\",\"location\":\"query\"},\"pageToken" +
            "\":{\"type\":\"string\",\"location\":\"query\"},\"projectId\":{\"type\":\"string\",\"required\":t" +
            "rue,\"location\":\"path\"}},\"parameterOrder\":[\"projectId\",\"datasetId\"],\"response\":{\"" +
            "$ref\":\"TableList\"},\"scopes\":[\"https://www.googleapis.com/auth/bigquery\"]},\"patch" +
            "\":{\"id\":\"bigquery.tables.patch\",\"path\":\"projects/{projectId}/datasets/{datasetId" +
            "}/tables/{tableId}\",\"httpMethod\":\"PATCH\",\"parameters\":{\"datasetId\":{\"type\":\"stri" +
            "ng\",\"required\":true,\"location\":\"path\"},\"projectId\":{\"type\":\"string\",\"required\":t" +
            "rue,\"location\":\"path\"},\"tableId\":{\"type\":\"string\",\"required\":true,\"location\":\"pa" +
            "th\"}},\"parameterOrder\":[\"projectId\",\"datasetId\",\"tableId\"],\"request\":{\"$ref\":\"Ta" +
            "ble\"},\"response\":{\"$ref\":\"Table\"},\"scopes\":[\"https://www.googleapis.com/auth/big" +
            "query\"]},\"update\":{\"id\":\"bigquery.tables.update\",\"path\":\"projects/{projectId}/da" +
            "tasets/{datasetId}/tables/{tableId}\",\"httpMethod\":\"PUT\",\"parameters\":{\"datasetId" +
            "\":{\"type\":\"string\",\"required\":true,\"location\":\"path\"},\"projectId\":{\"type\":\"strin" +
            "g\",\"required\":true,\"location\":\"path\"},\"tableId\":{\"type\":\"string\",\"required\":true" +
            ",\"location\":\"path\"}},\"parameterOrder\":[\"projectId\",\"datasetId\",\"tableId\"],\"reque" +
            "st\":{\"$ref\":\"Table\"},\"response\":{\"$ref\":\"Table\"},\"scopes\":[\"https://www.googleap" +
            "is.com/auth/bigquery\"]}}}}}";
    ...
    public class JobsResource {
        ...
        /// <param name="projectId">Required</param>
        public virtual InsertMediaUpload Insert(Google.Apis.Bigquery.v2beta1.Data.Job body, string projectId, System.IO.Stream stream, string contentType) {
        ...
        public class InsertMediaUpload : Google.Apis.Upload.ResumableUpload<Google.Apis.Bigquery.v2beta1.Data.Job, Google.Apis.Bigquery.v2beta1.Data.Job> {
            ...
            public InsertMediaUpload(Google.Apis.Discovery.IRequestProvider service, Google.Apis.Bigquery.v2beta1.Data.Job body, string projectId, System.IO.Stream stream, string contentType) : 
                    base(service.BaseUri, "/upload/bigquery/v2beta1/projects/{projectId}/jobs", "POST", stream, contentType) {
                this.Body = body;
