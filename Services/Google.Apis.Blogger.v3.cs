...
namespace Google.Apis.Blogger.v3 {
    ...
    public class BlogsResource {
        ...
        /// <param name="url">Required - The URL of the blog to retrieve.</param>
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Blog> {
            ...
            private void InitParameters() {
                ...
                parameters.Add("maxPosts", Google.Apis.Util.Utilities.CreateRuntimeParameter("maxPosts", false, "query", null, null, new string[0]));
                this._requestParameters = new Google.Apis.Util.ReadOnlyDictionary<string, Google.Apis.Discovery.IParameter>(parameters);
            }
        }
        
        public class GetByUrlRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Blog> {
            ...
            public GetByUrlRequest(Google.Apis.Discovery.IClientService service, string url) : 
                    base(service) {
                this._url = url;
                this.InitParameters();
            }
            ...
            private void InitParameters() {
                System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter> parameters = new System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter>();
                parameters.Add("url", Google.Apis.Util.Utilities.CreateRuntimeParameter("url", true, "query", null, null, new string[0]));
                this._requestParameters = new Google.Apis.Util.ReadOnlyDictionary<string, Google.Apis.Discovery.IParameter>(parameters);
            }
        }
        
        public class ListByUserRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.BlogList> {
            ...
            public ListByUserRequest(Google.Apis.Discovery.IClientService service, string userId) : 
                    base(service) {
                this._userId = userId;
                this.InitParameters();
            }
    ...
    public class CommentsResource {
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Comment> {
        ...
        public class ListRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.CommentList> {
    ...
    public class PagesResource {
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Page> {
        ...
        public class ListRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.PageList> {
    ...
    public class PostsResource {
        ...
        /// <param name="blogId">Required - ID of the blog to fetch the post from.</param>
        /// <param name="path">Required - Path of the Post to retrieve.</param>
        ...
        /// <param name="blogId">Required - ID of the blog to fetch the post from.</param>
        /// <param name="q">Required - Query terms to search this blog for matching posts.</param>
        ...
        public class DeleteRequest : Google.Apis.Requests.ClientServiceRequest<string> {
            ...
            public DeleteRequest(Google.Apis.Discovery.IClientService service, string blogId, string postId) : 
                    base(service) {
                this._blogId = blogId;
                this._postId = postId;
                this.InitParameters();
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Post> {
            ...
            private void InitParameters() {
                System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter> parameters = new System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter>();
                parameters.Add("blogId", Google.Apis.Util.Utilities.CreateRuntimeParameter("blogId", true, "path", null, null, new string[0]));
                parameters.Add("maxComments", Google.Apis.Util.Utilities.CreateRuntimeParameter("maxComments", false, "query", null, null, new string[0]));
                parameters.Add("postId", Google.Apis.Util.Utilities.CreateRuntimeParameter("postId", true, "path", null, null, new string[0]));
                this._requestParameters = new Google.Apis.Util.ReadOnlyDictionary<string, Google.Apis.Discovery.IParameter>(parameters);
            }
        }
        
        public class GetByPathRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Post> {
            ...
            public GetByPathRequest(Google.Apis.Discovery.IClientService service, string blogId, string path) : 
                    base(service) {
                this._blogId = blogId;
                this._path = path;
                this.InitParameters();
            ...
            public override string RestPath {
                get {
                    return "blogs/{blogId}/posts/bypath";
                }
            }
            ...
            private void InitParameters() {
                ...
                parameters.Add("blogId", Google.Apis.Util.Utilities.CreateRuntimeParameter("blogId", true, "path", null, null, new string[0]));
                parameters.Add("maxComments", Google.Apis.Util.Utilities.CreateRuntimeParameter("maxComments", false, "query", null, null, new string[0]));
                parameters.Add("path", Google.Apis.Util.Utilities.CreateRuntimeParameter("path", true, "query", null, null, new string[0]));
                this._requestParameters = new Google.Apis.Util.ReadOnlyDictionary<string, Google.Apis.Discovery.IParameter>(parameters);
            }
        }
        
        public class InsertRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Post> {
            ...
            public InsertRequest(Google.Apis.Discovery.IClientService service, Google.Apis.Blogger.v3.Data.Post body, string blogId) : 
                    base(service) {
                this.Body = body;
                this._blogId = blogId;
                this.InitParameters();
        ...
        public class ListRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.PostList> {
            ...
            private void InitParameters() {
                ...
                parameters.Add("endDate", Google.Apis.Util.Utilities.CreateRuntimeParameter("endDate", false, "query", null, null, new string[0]));
                parameters.Add("fetchBodies", Google.Apis.Util.Utilities.CreateRuntimeParameter("fetchBodies", false, "query", null, null, new string[0]));
                parameters.Add("labels", Google.Apis.Util.Utilities.CreateRuntimeParameter("labels", false, "query", null, null, new string[0]));
                parameters.Add("maxResults", Google.Apis.Util.Utilities.CreateRuntimeParameter("maxResults", false, "query", null, null, new string[0]));
                parameters.Add("pageToken", Google.Apis.Util.Utilities.CreateRuntimeParameter("pageToken", false, "query", null, null, new string[0]));
                parameters.Add("startDate", Google.Apis.Util.Utilities.CreateRuntimeParameter("startDate", false, "query", null, null, new string[0]));
                this._requestParameters = new Google.Apis.Util.ReadOnlyDictionary<string, Google.Apis.Discovery.IParameter>(parameters);
        ...
        public class PatchRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Post> {
            ...
            public PatchRequest(Google.Apis.Discovery.IClientService service, Google.Apis.Blogger.v3.Data.Post body, string blogId, string postId) : 
                    base(service) {
                this.Body = body;
                this._blogId = blogId;
                this._postId = postId;
        ...
        public class SearchRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.PostList> {
            ...
            public SearchRequest(Google.Apis.Discovery.IClientService service, string blogId, string q) : 
                    base(service) {
                this._blogId = blogId;
                this._q = q;
                this.InitParameters();
            ...
            public override string RestPath {
                get {
                    return "blogs/{blogId}/posts/search";
                }
            }
        ...
        public class UpdateRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.Post> {
            ...
            public UpdateRequest(Google.Apis.Discovery.IClientService service, Google.Apis.Blogger.v3.Data.Post body, string blogId, string postId) : 
                    base(service) {
                this.Body = body;
                this._blogId = blogId;
                this._postId = postId;
    ...
    public class UsersResource {
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Blogger.v3.Data.User> {
