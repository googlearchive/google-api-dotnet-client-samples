...
namespace Google.Apis.Discovery.v1 {
    ...
    public partial class DiscoveryService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"discoveryVersion\":\"v1\",\"id\":\"discovery:v1\",\"" +
            ...
            ",\"supportsMediaDownload\":{\"type\":\"boolean\",\"description\":\"Whether this method su" +
            "pports media downloads.\"},\"supportsMediaUpload\":{\"type\":\"boolean\",\"description\":" +
            "\"Whether this method supports media uploads.\"},\"supportsSubscription\":{\"type\":\"b" +
            "oolean\",\"description\":\"Whether this method supports subscriptions.\"}}},\"RestReso" +
            "urce\":{\"id\":\"RestResource\",\"type\":\"object\",\"properties\":{\"methods\":{\"type\":\"obje" +
            "ct\",\"description\":\"Methods on this resource.\",\"additionalProperties\":{\"$ref\":\"Re" +
            "stMethod\",\"description\":\"Description for any methods on this resource.\"}},\"resou" +
            "rces\":{\"type\":\"object\",\"description\":\"Sub-resources on this resource.\",\"addition" +
            "alProperties\":{\"$ref\":\"RestResource\",\"description\":\"Description for any sub-reso" +
            "urces on this resource.\"}}}}},\"resources\":{\"apis\":{\"methods\":{\"getRest\":{\"id\":\"d" +
            "iscovery.apis.getRest\",\"path\":\"apis/{api}/{version}/rest\",\"httpMethod\":\"GET\",\"de" +
            "scription\":\"Retrieve the description of a particular version of an api.\",\"parame" +
            "ters\":{\"api\":{\"type\":\"string\",\"description\":\"The name of the API.\",\"required\":tr" +
            "ue,\"location\":\"path\"},\"version\":{\"type\":\"string\",\"description\":\"The version of t" +
            "he API.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"api\",\"version\"]," +
            "\"response\":{\"$ref\":\"RestDescription\"}},\"list\":{\"id\":\"discovery.apis.list\",\"path\"" +
            ":\"apis\",\"httpMethod\":\"GET\",\"description\":\"Retrieve the list of APIs supported at" +
            " this endpoint.\",\"parameters\":{\"label\":{\"type\":\"string\",\"description\":\"Only incl" +
            "ude APIs with a matching label, such as \'graduated\' or \'labs\'.\",\"enum\":[\"depreca" +
            "ted\",\"graduated\",\"labs\"],\"enumDescriptions\":[\"APIs that have been deprecated.\",\"" +
            "Supported APIs that have graduated from labs.\",\"APIs that are experimental\"],\"lo" +
            "cation\":\"query\"},\"name\":{\"type\":\"string\",\"description\":\"Only include APIs with t" +
            "he given name.\",\"location\":\"query\"},\"preferred\":{\"type\":\"boolean\",\"description\":" +
            "\"Return only the preferred version of an API.\",\"default\":\"false\",\"location\":\"que" +
            "ry\"}},\"response\":{\"$ref\":\"DirectoryList\"}}}}}}";
