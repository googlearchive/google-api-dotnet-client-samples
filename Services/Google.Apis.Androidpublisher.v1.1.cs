...
namespace Google.Apis.Androidpublisher.v1_1.Data {
    ...
    public class InappPurchase : Google.Apis.Requests.IDirectResponseSchema {
        
        private System.Nullable<long> _consumptionState;
        
        private string _developerPayload;
        
        private string _kind;
        
        private System.Nullable<long> _purchaseState;
        
        private string _purchaseTime;
        
        private string _ETag;
        
        /// <summary>The consumption state of the inapp product. Possible values are:  
        ///- - Consumed 
        ///- - Yet to be consumed</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("consumptionState")]
        public virtual System.Nullable<long> ConsumptionState {
            get {
                return this._consumptionState;
            }
            set {
                this._consumptionState = value;
            }
        }
        ...
        public virtual string DeveloperPayload {
            ...
            set {
                this._developerPayload = value;
            }
        }
        
        /// <summary>This kind represents a inappPurchase object in the androidpublisher service.</summary>
        ...
        /// <summary>The purchase state of the order. Possible values are:  
        ///- - Purchased 
        ///- - Cancelled</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("purchaseState")]
        public virtual System.Nullable<long> PurchaseState {
            get {
...
namespace Google.Apis.Androidpublisher.v1_1 {
    ...
    public partial class AndroidPublisherService : Google.Apis.Services.BaseClientService {
        ...
        public AndroidPublisherService(Google.Apis.Services.BaseClientService.Initializer initializer) : 
                base(initializer) {
            this._inapppurchases = new InapppurchasesResource(this, Authenticator);
        ...
        public override string BaseUri {
            get {
                return "https://www.googleapis.com/androidpublisher/v1.1/applications/";
            }
        }
        
        public override string BasePath {
            get {
                return "/androidpublisher/v1.1/applications/";
            }
        }
    ...
    public class InapppurchasesResource {
        ...
        private const string Resource = "inapppurchases";
        
        public InapppurchasesResource(AndroidPublisherService service, Google.Apis.Authentication.IAuthenticator authenticator) {
            this.service = service;
            this.authenticator = authenticator;
        }
        
        /// <summary>Checks the purchase and consumption status of an inapp item.</summary>
        /// <param name="packageName">Required - The package name of the application the inapp product was sold in (for example, &apos;com.some.thing&apos;).</param>
        /// <param name="productId">Required - The inapp product SKU (for example, &apos;com.some.thing.inapp1&apos;).</param>
        /// <param name="token">Required - The token provided to the user&apos;s device when the inapp product was purchased.</param>
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Androidpublisher.v1_1.Data.InappPurchase> {
            ...
            /// <summary>The package name of the application the inapp product was sold in (for example, 'com.some.thing').</summary>
            ...
            public override string RestPath {
                get {
                    return "{packageName}/inapp/{productId}/purchases/{token}";
                }
            }
    ...
    public class PurchasesResource {
        ...
        public class GetRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Androidpublisher.v1_1.Data.SubscriptionPurchase> {
    ...
    public partial class AndroidPublisherService {
        ...
        private InapppurchasesResource _inapppurchases;
