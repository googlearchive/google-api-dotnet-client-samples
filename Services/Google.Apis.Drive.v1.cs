...
namespace Google.Apis.Drive.v1 {
    ...
    public partial class DriveService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"discoveryVersion\":\"v1\",\"id\":\"drive:v1\",\"name" +
            "\":\"drive\",\"version\":\"v1\",\"revision\":\"20120501\",\"title\":\"Drive API\",\"description\"" +
            ...
            "col\":\"rest\",\"baseUrl\":\"https://www.googleapis.com/drive/v1/\",\"basePath\":\"/drive/" +
            "v1/\",\"rootUrl\":\"https://www.googleapis.com/\",\"servicePath\":\"drive/v1/\",\"batchPat" +
            ...
            "ve.file\":{\"description\":\"View and manage Google Drive files that you have opened" +
            " or created with this app\"}}}},\"schemas\":{\"File\":{\"id\":\"File\",\"type\":\"object\",\"d" +
            "escription\":\"The metadata for a file.\",\"properties\":{\"createdDate\":{\"type\":\"stri" +
            "ng\",\"description\":\"Create time for this file (formatted ISO8601 timestamp).\",\"fo" +
            "rmat\":\"date-time\"},\"description\":{\"type\":\"string\",\"description\":\"A short descrip" +
            "tion of the file\"},\"downloadUrl\":{\"type\":\"string\",\"description\":\"Short term down" +
            "load URL for the file. This will only be populated on files with content stored " +
            "in Drive.\"},\"etag\":{\"type\":\"string\",\"description\":\"ETag of the file.\"},\"fileExte" +
            "nsion\":{\"type\":\"string\",\"description\":\"The file extension used when downloading " +
            "this file. This field is read only. To set the extension, include it on title wh" +
            "en creating the file. This will only be populated on files with content stored i" +
            "n Drive.\"},\"fileSize\":{\"type\":\"string\",\"description\":\"The size of the file in by" +
            "tes. This will only be populated on files with content stored in Drive.\",\"format" +
            "\":\"int64\"},\"id\":{\"type\":\"string\",\"description\":\"The id of the file.\"},\"indexable" +
            "Text\":{\"type\":\"object\",\"description\":\"Indexable text attributes for the file (ca" +
            "n only be written)\",\"properties\":{\"text\":{\"type\":\"string\",\"description\":\"The tex" +
            "t to be indexed for this file\"}}},\"kind\":{\"type\":\"string\",\"description\":\"The typ" +
            "e of file. This is always drive#file\",\"default\":\"drive#file\"},\"labels\":{\"type\":\"" +
            "object\",\"description\":\"Labels for the file.\",\"properties\":{\"hidden\":{\"type\":\"boo" +
            "lean\",\"description\":\"Whether this file is hidden from the user\"},\"starred\":{\"typ" +
            "e\":\"boolean\",\"description\":\"Whether this file is starred by the user.\"},\"trashed" +
            "\":{\"type\":\"boolean\",\"description\":\"Whether this file has been trashed.\"}}},\"last" +
            "ViewedDate\":{\"type\":\"string\",\"description\":\"Last time this file was viewed by th" +
            "e user (formatted RFC 3339 timestamp).\",\"format\":\"date-time\"},\"md5Checksum\":{\"ty" +
            "pe\":\"string\",\"description\":\"An MD5 checksum for the content of this file. This w" +
            "ill only be populated on files with content stored in Drive.\"},\"mimeType\":{\"type" +
            "\":\"string\",\"description\":\"The mimetype of the file\"},\"modifiedByMeDate\":{\"type\":" +
            "\"string\",\"description\":\"Last time this file was modified by the user (formatted " +
            "RFC 3339 timestamp).\",\"format\":\"date-time\"},\"modifiedDate\":{\"type\":\"string\",\"des" +
            "cription\":\"Last time this file was modified by anyone (formatted RFC 3339 timest" +
            "amp).\",\"format\":\"date-time\"},\"parentsCollection\":{\"type\":\"array\",\"description\":\"" +
            "Collection of parent folders which contain this file.\\nOn insert, setting this f" +
            "ield will put the file in all of the provided folders. If no folders are provide" +
            "d, the file will be placed in the default root folder. On update, this field is " +
            "ignored.\",\"items\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"descript" +
            "ion\":\"The id of this parent\"},\"parentLink\":{\"type\":\"string\",\"description\":\"A lin" +
            "k to get the metadata for this parent\"}}}},\"selfLink\":{\"type\":\"string\",\"descript" +
            "ion\":\"A link back to this file.\"},\"title\":{\"type\":\"string\",\"description\":\"The ti" +
            "tle of this file.\"},\"userPermission\":{\"$ref\":\"Permission\",\"description\":\"The per" +
            "missions for the authenticated user on this file.\"}}},\"Permission\":{\"id\":\"Permis" +
            "sion\",\"type\":\"object\",\"description\":\"A single permission for a file.\",\"propertie" +
            "s\":{\"additionalRoles\":{\"type\":\"array\",\"description\":\"Any additional roles that t" +
            "his permission describes.\",\"items\":{\"type\":\"string\"}},\"etag\":{\"type\":\"string\",\"d" +
            "escription\":\"An etag for this permission.\"},\"kind\":{\"type\":\"string\",\"description" +
            "\":\"The kind of this permission. This is always drive#permission\",\"default\":\"driv" +
            "e#permission\"},\"role\":{\"type\":\"string\",\"description\":\"The role that this permiss" +
            "ion describes. (For example: reader, writer, owner)\"},\"type\":{\"type\":\"string\",\"d" +
            "escription\":\"The type of permission (For example: user, group etc).\"}}}},\"resour" +
            "ces\":{\"files\":{\"methods\":{\"get\":{\"id\":\"drive.files.get\",\"path\":\"files/{id}\",\"htt" +
            "pMethod\":\"GET\",\"description\":\"Gets a file\'s metadata by id.\",\"parameters\":{\"id\":" +
            "{\"type\":\"string\",\"description\":\"The id for the file in question.\",\"required\":tru" +
            "e,\"location\":\"path\"},\"projection\":{\"type\":\"string\",\"description\":\"Restrict infor" +
            "mation returned for simplicity and optimization.\",\"enum\":[\"BASIC\",\"FULL\"],\"enumD" +
            "escriptions\":[\"Includes only the basic metadata fields\",\"Includes all metadata f" +
            "ields\"],\"location\":\"query\"},\"updateViewedDate\":{\"type\":\"boolean\",\"description\":\"" +
            "Whether to update the view date after successfully retrieving the file.\",\"defaul" +
            "t\":\"true\",\"location\":\"query\"}},\"parameterOrder\":[\"id\"],\"response\":{\"$ref\":\"File\"" +
            "},\"scopes\":[\"https://www.googleapis.com/auth/drive.file\"]},\"insert\":{\"id\":\"drive" +
            ".files.insert\",\"path\":\"files\",\"httpMethod\":\"POST\",\"description\":\"Inserts a file," +
            " and any settable metadata or blob content sent with the request.\",\"request\":{\"$" +
            "ref\":\"File\"},\"response\":{\"$ref\":\"File\"},\"scopes\":[\"https://www.googleapis.com/au" +
            "th/drive.file\"],\"supportsMediaUpload\":true,\"mediaUpload\":{\"accept\":[\"*/*\"],\"maxS" +
            "ize\":\"10GB\",\"protocols\":{\"simple\":{\"multipart\":true,\"path\":\"/upload/drive/v1/fil" +
            "es\"},\"resumable\":{\"multipart\":true,\"path\":\"/resumable/upload/drive/v1/files\"}}}}" +
            ",\"patch\":{\"id\":\"drive.files.patch\",\"path\":\"files/{id}\",\"httpMethod\":\"PATCH\",\"des" +
            "cription\":\"Updates file metadata and/or content. This method supports patch sema" +
            "ntics.\",\"parameters\":{\"id\":{\"type\":\"string\",\"description\":\"The id for the file i" +
            "n question.\",\"required\":true,\"location\":\"path\"},\"newRevision\":{\"type\":\"boolean\"," +
            "\"description\":\"Whether a blob upload should create a new revision. If not set or" +
            ...
            "\"Controls updating the modified date of the file. If true, the modified date wil" +
            "l be updated to the current time, regardless of whether other changes are being " +
            "made. If false, the modified date will only be updated to the current time if ot" +
            "her changes are also being made (changing the title, for example).\",\"default\":\"f" +
            "alse\",\"location\":\"query\"},\"updateViewedDate\":{\"type\":\"boolean\",\"description\":\"Wh" +
            "ether to update the view date after successfully updating the file.\",\"default\":\"" +
            "true\",\"location\":\"query\"}},\"parameterOrder\":[\"id\"],\"request\":{\"$ref\":\"File\"},\"re" +
            "sponse\":{\"$ref\":\"File\"},\"scopes\":[\"https://www.googleapis.com/auth/drive.file\"]}" +
            ",\"update\":{\"id\":\"drive.files.update\",\"path\":\"files/{id}\",\"httpMethod\":\"PUT\",\"des" +
            "cription\":\"Updates file metadata and/or content\",\"parameters\":{\"id\":{\"type\":\"str" +
            ...
            "s://www.googleapis.com/auth/drive.file\"],\"supportsMediaUpload\":true,\"mediaUpload" +
            "\":{\"accept\":[\"*/*\"],\"maxSize\":\"10GB\",\"protocols\":{\"simple\":{\"multipart\":true,\"pa" +
            "th\":\"/upload/drive/v1/files/{id}\"},\"resumable\":{\"multipart\":true,\"path\":\"/resuma" +
            "ble/upload/drive/v1/files/{id}\"}}}}}}}}";
