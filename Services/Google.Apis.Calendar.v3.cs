...
namespace Google.Apis.Calendar.v3.Data {
    ...
    public class Event : Google.Apis.Requests.IDirectResponseSchema {
        ...
        private Event.SourceData _source;
        ...
        /// <summary>Source of an event from which it was created; for example a web page, an email message or any document identifiable by an URL using HTTP/HTTPS protocol. Accessible only by the creator of the event.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("source")]
        public virtual Event.SourceData Source {
            get {
                return this._source;
            }
            set {
        ...
        public class SourceData {
            ...
            /// <summary>URL of the source pointing to a resource. URL&apos;s protocol must be HTTP or HTTPS.</summary>
