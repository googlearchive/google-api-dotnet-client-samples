...
namespace Google.Apis.Plus.v1 {
    ...
    public partial class PlusService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"etag\":\"\\\"a3GBuXuTtUYW9BV1SIieU5LiL7w/UF3R3J6" +
            "GybMqi5Ric8P0pBn_VHE\\\"\",\"discoveryVersion\":\"v1\",\"id\":\"plus:v1\",\"name\":\"plus\",\"ve" +
            "rsion\":\"v1\",\"revision\":\"20121115\",\"title\":\"Google+ API\",\"description\":\"The Googl" +
            ...
            "objectType\":{\"type\":\"string\"},\"thumbnails\":{\"type\":\"array\",\"description\":\"If the" +
            " attachment is an album, potential additional thumbnails from the album.\",\"items" +
            "\":{\"type\":\"object\",\"properties\":{\"description\":{\"type\":\"string\",\"description\":\"P" +
            "otential name of the thumbnail.\"},\"image\":{\"type\":\"object\",\"description\":\"Image " +
            "resource.\",\"properties\":{\"height\":{\"type\":\"integer\",\"description\":\"The height, i" +
            "n pixels, of the linked resource.\",\"format\":\"uint32\"},\"type\":{\"type\":\"string\",\"d" +
            "escription\":\"Media type of the link.\"},\"url\":{\"type\":\"string\",\"description\":\"Ima" +
            "ge url.\"},\"width\":{\"type\":\"integer\",\"description\":\"The width, in pixels, of the " +
            "linked resource.\",\"format\":\"uint32\"}}},\"url\":{\"type\":\"string\",\"description\":\"URL" +
            " to the webpage containing the image.\"}}}},\"url\":{\"type\":\"string\",\"description\":" +
            "\"The link to the attachment, should be of type text/html.\"}}}},\"content\":{\"type\"" +
            ":\"string\",\"description\":\"The HTML-formatted content, suitable for display.\"},\"id" +
            "\":{\"type\":\"string\",\"description\":\"The ID of the object. When resharing an activi" +
            "ty, this is the ID of the activity being reshared.\"},\"objectType\":{\"type\":\"strin" +
            "g\",\"description\":\"The type of the object. Possible values are:  \\n- \\\"note\\\" - T" +
            "extual content. \\n- \\\"activity\\\" - A Google+ activity.\"},\"originalContent\":{\"typ" +
            "e\":\"string\",\"description\":\"The content (text) as provided by the author, stored " +
            "without any HTML formatting. When creating or updating an activity, this value m" +
            "ust be supplied as plain text in the request.\"},\"plusoners\":{\"type\":\"object\",\"de" +
            "scription\":\"People who +1\'d this activity.\",\"properties\":{\"selfLink\":{\"type\":\"st" +
            "ring\",\"description\":\"The URL for the collection of people who +1\'d this activity" +
            ".\"},\"totalItems\":{\"type\":\"integer\",\"description\":\"Total number of people who +1\'" +
            "d this activity.\",\"format\":\"uint32\"}}},\"replies\":{\"type\":\"object\",\"description\":" +
            "\"Comments in reply to this activity.\",\"properties\":{\"selfLink\":{\"type\":\"string\"," +
            "\"description\":\"The URL for the collection of comments in reply to this activity." +
            "\"},\"totalItems\":{\"type\":\"integer\",\"description\":\"Total number of comments on thi" +
            "s activity.\",\"format\":\"uint32\"}}},\"resharers\":{\"type\":\"object\",\"description\":\"Pe" +
            "ople who reshared this activity.\",\"properties\":{\"selfLink\":{\"type\":\"string\",\"des" +
            "cription\":\"The URL for the collection of resharers.\"},\"totalItems\":{\"type\":\"inte" +
            "ger\",\"description\":\"Total number of people who reshared this activity.\",\"format\"" +
            ":\"uint32\"}}},\"url\":{\"type\":\"string\",\"description\":\"The URL that points to the li" +
            "nked resource.\"}}},\"placeId\":{\"type\":\"string\",\"description\":\"ID of the place whe" +
            "re this activity occurred.\"},\"placeName\":{\"type\":\"string\",\"description\":\"Name of" +
            " the place where this activity occurred.\"},\"provider\":{\"type\":\"object\",\"descript" +
            "ion\":\"The service provider that initially published this activity.\",\"properties\"" +
            ":{\"title\":{\"type\":\"string\",\"description\":\"Name of the service provider.\"}}},\"pub" +
            "lished\":{\"type\":\"string\",\"description\":\"The time at which this activity was init" +
            "ially published. Formatted as an RFC 3339 timestamp.\",\"format\":\"date-time\"},\"rad" +
            "ius\":{\"type\":\"string\",\"description\":\"Radius, in meters, of the region where this" +
            " activity occurred, centered at the latitude and longitude identified in geocode" +
            ".\"},\"title\":{\"type\":\"string\",\"description\":\"Title of this activity.\"},\"updated\":" +
            "{\"type\":\"string\",\"description\":\"The time at which this activity was last updated" +
            ". Formatted as an RFC 3339 timestamp.\",\"format\":\"date-time\"},\"url\":{\"type\":\"stri" +
            "ng\",\"description\":\"The link to this activity.\"},\"verb\":{\"type\":\"string\",\"descrip" +
            "tion\":\"This activity\'s verb, indicating what action was performed. Possible valu" +
            "es are:  \\n- \\\"checkin\\\" - Check in to a location. \\n- \\\"post\\\" - Publish conten" +
            "t to the stream. \\n- \\\"share\\\" - Reshare an activity.\"}}},\"ActivityFeed\":{\"id\":\"" +
            "ActivityFeed\",\"type\":\"object\",\"properties\":{\"etag\":{\"type\":\"string\",\"description" +
            "\":\"ETag of this response for caching purposes.\"},\"id\":{\"type\":\"string\",\"descript" +
            "ion\":\"The ID of this collection of activities.\"},\"items\":{\"type\":\"array\",\"descri" +
            "ption\":\"The activities in this page of results.\",\"items\":{\"$ref\":\"Activity\"}},\"k" +
            "ind\":{\"type\":\"string\",\"description\":\"Identifies this resource as a collection of" +
            " activities. Value: \\\"plus#activityFeed\\\".\",\"default\":\"plus#activityFeed\"},\"next" +
            "Link\":{\"type\":\"string\",\"description\":\"Link to the next page of activities.\"},\"ne" +
            "xtPageToken\":{\"type\":\"string\",\"description\":\"The continuation token, which is us" +
            ...
            ":\"Link to this activity resource.\"},\"title\":{\"type\":\"string\",\"description\":\"The " +
            "title of this collection of activities.\"},\"updated\":{\"type\":\"string\",\"descriptio" +
            "n\":\"The time at which this collection of activities was last updated. Formatted " +
            "as an RFC 3339 timestamp.\",\"format\":\"date-time\"}}},\"Comment\":{\"id\":\"Comment\",\"ty" +
            "pe\":\"object\",\"properties\":{\"actor\":{\"type\":\"object\",\"description\":\"The person wh" +
            "o posted this comment.\",\"properties\":{\"displayName\":{\"type\":\"string\",\"descriptio" +
            "n\":\"The name of this actor, suitable for display.\"},\"id\":{\"type\":\"string\",\"descr" +
            "iption\":\"The ID of the actor.\"},\"image\":{\"type\":\"object\",\"description\":\"The imag" +
            "e representation of this actor.\",\"properties\":{\"url\":{\"type\":\"string\",\"descripti" +
            "on\":\"The URL of the actor\'s profile photo. To re-size the image and crop it to a" +
            " square, append the query string ?sz=x, where x is the dimension in pixels of ea" +
            "ch side.\"}}},\"url\":{\"type\":\"string\",\"description\":\"A link to the person resource" +
            " for this actor.\"}}},\"etag\":{\"type\":\"string\",\"description\":\"ETag of this respons" +
            "e for caching purposes.\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of this co" +
            "mment.\"},\"inReplyTo\":{\"type\":\"array\",\"description\":\"The activity this comment re" +
            "plied to.\",\"items\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"descrip" +
            "tion\":\"The ID of the activity.\"},\"url\":{\"type\":\"string\",\"description\":\"The URL o" +
            "f the activity.\"}}}},\"kind\":{\"type\":\"string\",\"description\":\"Identifies this reso" +
            "urce as a comment. Value: \\\"plus#comment\\\".\",\"default\":\"plus#comment\"},\"object\":" +
            "{\"type\":\"object\",\"description\":\"The object of this comment.\",\"properties\":{\"cont" +
            "ent\":{\"type\":\"string\",\"description\":\"The HTML-formatted content, suitable for di" +
            "splay.\"},\"objectType\":{\"type\":\"string\",\"description\":\"The object type of this co" +
            "mment. Possible values are:  \\n- \\\"comment\\\" - A comment in reply to an activity" +
            ".\",\"default\":\"comment\"},\"originalContent\":{\"type\":\"string\",\"description\":\"The co" +
            "ntent (text) as provided by the author, stored without any HTML formatting. When" +
            " creating or updating a comment, this value must be supplied as plain text in th" +
            "e request.\"}}},\"plusoners\":{\"type\":\"object\",\"description\":\"People who +1\'d this " +
            "comment.\",\"properties\":{\"totalItems\":{\"type\":\"integer\",\"description\":\"Total numb" +
            "er of people who +1\'d this comment.\",\"format\":\"uint32\"}}},\"published\":{\"type\":\"s" +
            "tring\",\"description\":\"The time at which this comment was initially published. Fo" +
            "rmatted as an RFC 3339 timestamp.\",\"format\":\"date-time\"},\"selfLink\":{\"type\":\"str" +
            "ing\",\"description\":\"Link to this comment resource.\"},\"updated\":{\"type\":\"string\"," +
            "\"description\":\"The time at which this comment was last updated. Formatted as an " +
            "RFC 3339 timestamp.\",\"format\":\"date-time\"},\"verb\":{\"type\":\"string\",\"description\"" +
            ":\"This comment\'s verb, indicating what action was performed. Possible values are" +
            ":  \\n- \\\"post\\\" - Publish content to the stream.\",\"default\":\"post\"}}},\"CommentFe" +
            "ed\":{\"id\":\"CommentFeed\",\"type\":\"object\",\"properties\":{\"etag\":{\"type\":\"string\",\"d" +
            "escription\":\"ETag of this response for caching purposes.\"},\"id\":{\"type\":\"string\"" +
            ",\"description\":\"The ID of this collection of comments.\"},\"items\":{\"type\":\"array\"" +
            ",\"description\":\"The comments in this page of results.\",\"items\":{\"$ref\":\"Comment\"" +
            "}},\"kind\":{\"type\":\"string\",\"description\":\"Identifies this resource as a collecti" +
            "on of comments. Value: \\\"plus#commentFeed\\\".\",\"default\":\"plus#commentFeed\"},\"nex" +
            "tLink\":{\"type\":\"string\",\"description\":\"Link to the next page of activities.\"},\"n" +
            "extPageToken\":{\"type\":\"string\",\"description\":\"The continuation token, which is u" +
            "sed to page through large result sets. Provide this value in a subsequent reques" +
            "t to return the next page of results.\"},\"title\":{\"type\":\"string\",\"description\":\"" +
            "The title of this collection of comments.\"},\"updated\":{\"type\":\"string\",\"descript" +
            "ion\":\"The time at which this collection of comments was last updated. Formatted " +
            "as an RFC 3339 timestamp.\",\"format\":\"date-time\"}}},\"PeopleFeed\":{\"id\":\"PeopleFee" +
            "d\",\"type\":\"object\",\"properties\":{\"etag\":{\"type\":\"string\",\"description\":\"ETag of " +
            "this response for caching purposes.\"},\"items\":{\"type\":\"array\",\"description\":\"The" +
            " people in this page of results. Each item includes the id, displayName, image, " +
            "and url for the person. To retrieve additional profile data, see the people.get " +
            "method.\",\"items\":{\"$ref\":\"Person\"}},\"kind\":{\"type\":\"string\",\"description\":\"Ident" +
            "ifies this resource as a collection of people. Value: \\\"plus#peopleFeed\\\".\",\"def" +
            "ault\":\"plus#peopleFeed\"},\"nextPageToken\":{\"type\":\"string\",\"description\":\"The con" +
            "tinuation token, which is used to page through large result sets. Provide this v" +
            "alue in a subsequent request to return the next page of results.\"},\"selfLink\":{\"" +
            "type\":\"string\",\"description\":\"Link to this resource.\"},\"title\":{\"type\":\"string\"," +
            "\"description\":\"The title of this collection of people.\"},\"totalItems\":{\"type\":\"i" +
            "nteger\",\"description\":\"The total number of people available in this list. The nu" +
            "mber of people in a response might be smaller due to paging. This might not be s" +
            "et for all collections.\",\"format\":\"int32\"}}},\"Person\":{\"id\":\"Person\",\"type\":\"obj" +
            "ect\",\"properties\":{\"aboutMe\":{\"type\":\"string\",\"description\":\"A short biography f" +
            "or this person.\"},\"birthday\":{\"type\":\"string\",\"description\":\"The person\'s date o" +
            "f birth, represented as YYYY-MM-DD.\"},\"circledByCount\":{\"type\":\"integer\",\"descri" +
            "ption\":\"If a Google+ Page and for followers who are visible, the number of peopl" +
            "e who have added this page to a circle.\",\"format\":\"int32\"},\"cover\":{\"type\":\"obje" +
            "ct\",\"description\":\"The cover photo content.\",\"properties\":{\"coverInfo\":{\"type\":\"" +
            "object\",\"description\":\"Extra information about the cover photo.\",\"properties\":{\"" +
            "leftImageOffset\":{\"type\":\"integer\",\"description\":\"The difference between the lef" +
            "t position of the image cover and the actual displayed cover image. Only valid f" +
            "or BANNER layout.\",\"format\":\"int32\"},\"topImageOffset\":{\"type\":\"integer\",\"descrip" +
            "tion\":\"The difference between the top position of the image cover and the actual" +
            " displayed cover image. Only valid for BANNER layout.\",\"format\":\"int32\"}}},\"cove" +
            "rPhoto\":{\"type\":\"object\",\"description\":\"The person\'s primary cover image.\",\"prop" +
            "erties\":{\"height\":{\"type\":\"integer\",\"description\":\"The height to the image.\",\"fo" +
            "rmat\":\"int32\"},\"url\":{\"type\":\"string\",\"description\":\"The url to the image.\"},\"wi" +
            "dth\":{\"type\":\"integer\",\"description\":\"The width to the image.\",\"format\":\"int32\"}" +
            "}},\"layout\":{\"type\":\"string\",\"description\":\"The layout of the cover art. Possibl" +
            "e values are:  \\n- \\\"banner\\\" - One large image banner.\"}}},\"currentLocation\":{\"" +
            "type\":\"string\",\"description\":\"The current location for this person.\"},\"displayNa" +
            "me\":{\"type\":\"string\",\"description\":\"The name of this person, suitable for displa" +
            "y.\"},\"emails\":{\"type\":\"array\",\"description\":\"A list of email addresses for this " +
            "person.\",\"items\":{\"type\":\"object\",\"properties\":{\"primary\":{\"type\":\"boolean\",\"des" +
            "cription\":\"If \\\"true\\\", indicates this email address is the person\'s primary one" +
            ".\"},\"type\":{\"type\":\"string\",\"description\":\"The type of address. Possible values " +
            "are:  \\n- \\\"home\\\" - Home email address. \\n- \\\"work\\\" - Work email address. \\n- " +
            "\\\"other\\\" - Other.\"},\"value\":{\"type\":\"string\",\"description\":\"The email address.\"" +
            "}}}},\"etag\":{\"type\":\"string\",\"description\":\"ETag of this response for caching pu" +
            "rposes.\"},\"gender\":{\"type\":\"string\",\"description\":\"The person\'s gender. Possible" +
            " values are:  \\n- \\\"male\\\" - Male gender. \\n- \\\"female\\\" - Female gender. \\n- \\\"" +
            "other\\\" - Other.\"},\"hasApp\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", indica" +
            "tes that the person has installed the app that is making the request and has cho" +
            "sen to expose this install state to the caller. A value of \\\"false\\\" indicates t" +
            "hat the install state cannot be determined (it is either not installed or the pe" +
            "rson has chosen to keep this information private).\"},\"id\":{\"type\":\"string\",\"desc" +
            "ription\":\"The ID of this person.\"},\"image\":{\"type\":\"object\",\"description\":\"The r" +
            "epresentation of the person\'s profile photo.\",\"properties\":{\"url\":{\"type\":\"strin" +
            "g\",\"description\":\"The URL of the person\'s profile photo. To re-size the image an" +
            "d crop it to a square, append the query string ?sz=x, where x is the dimension i" +
            "n pixels of each side.\"}}},\"isPlusUser\":{\"type\":\"boolean\",\"description\":\"Whether" +
            " this user has signed up for Google+.\"},\"kind\":{\"type\":\"string\",\"description\":\"I" +
            "dentifies this resource as a person. Value: \\\"plus#person\\\".\",\"default\":\"plus#pe" +
            "rson\"},\"name\":{\"type\":\"object\",\"description\":\"An object representation of the in" +
            "dividual components of a person\'s name.\",\"properties\":{\"familyName\":{\"type\":\"str" +
            "ing\",\"description\":\"The family name (last name) of this person.\"},\"formatted\":{\"" +
            "type\":\"string\",\"description\":\"The full name of this person, including middle nam" +
            "es, suffixes, etc.\"},\"givenName\":{\"type\":\"string\",\"description\":\"The given name " +
            "(first name) of this person.\"},\"honorificPrefix\":{\"type\":\"string\",\"description\":" +
            "\"The honorific prefixes (such as \\\"Dr.\\\" or \\\"Mrs.\\\") for this person.\"},\"honori" +
            "ficSuffix\":{\"type\":\"string\",\"description\":\"The honorific suffixes (such as \\\"Jr." +
            "\\\") for this person.\"},\"middleName\":{\"type\":\"string\",\"description\":\"The middle n" +
            "ame of this person.\"}}},\"nickname\":{\"type\":\"string\",\"description\":\"The nickname " +
            "of this person.\"},\"objectType\":{\"type\":\"string\",\"description\":\"Type of person wi" +
            "thin Google+. Possible values are:  \\n- \\\"person\\\" - represents an actual person" +
            ". \\n- \\\"page\\\" - represents a page.\"},\"organizations\":{\"type\":\"array\",\"descripti" +
            "on\":\"A list of current or past organizations with which this person is associate" +
            "d.\",\"items\":{\"type\":\"object\",\"properties\":{\"department\":{\"type\":\"string\",\"descri" +
            "ption\":\"The department within the organization. Deprecated.\"},\"description\":{\"ty" +
            "pe\":\"string\",\"description\":\"A short description of the person\'s role in this org" +
            "anization. Deprecated.\"},\"endDate\":{\"type\":\"string\",\"description\":\"The date the " +
            "person left this organization.\"},\"location\":{\"type\":\"string\",\"description\":\"The " +
            "location of this organization. Deprecated.\"},\"name\":{\"type\":\"string\",\"descriptio" +
            "n\":\"The name of the organization.\"},\"primary\":{\"type\":\"boolean\",\"description\":\"I" +
            "f \\\"true\\\", indicates this organization is the person\'s primary one (typically i" +
            "nterpreted as current one).\"},\"startDate\":{\"type\":\"string\",\"description\":\"The da" +
            "te the person joined this organization.\"},\"title\":{\"type\":\"string\",\"description\"" +
            ":\"The person\'s job title or role within the organization.\"},\"type\":{\"type\":\"stri" +
            "ng\",\"description\":\"The type of organization. Possible values are:  \\n- \\\"work\\\" " +
            "- Work. \\n- \\\"school\\\" - School.\"}}}},\"placesLived\":{\"type\":\"array\",\"description" +
            "\":\"A list of places where this person has lived.\",\"items\":{\"type\":\"object\",\"prop" +
            "erties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", this place of r" +
            "esidence is this person\'s primary residence.\"},\"value\":{\"type\":\"string\",\"descrip" +
            "tion\":\"A place where this person has lived. For example: \\\"Seattle, WA\\\", \\\"Near" +
            " Toronto\\\".\"}}}},\"plusOneCount\":{\"type\":\"integer\",\"description\":\"If a Google+ Pa" +
            "ge, the number of people who have +1\'ed this page.\",\"format\":\"int32\"},\"relations" +
            "hipStatus\":{\"type\":\"string\",\"description\":\"The person\'s relationship status. Pos" +
            "sible values are:  \\n- \\\"single\\\" - Person is single. \\n- \\\"in_a_relationship\\\" " +
            "- Person is in a relationship. \\n- \\\"engaged\\\" - Person is engaged. \\n- \\\"marrie" +
            "d\\\" - Person is married. \\n- \\\"its_complicated\\\" - The relationship is complicat" +
            "ed. \\n- \\\"open_relationship\\\" - Person is in an open relationship. \\n- \\\"widowed" +
            "\\\" - Person is widowed. \\n- \\\"in_domestic_partnership\\\" - Person is in a domesti" +
            "c partnership. \\n- \\\"in_civil_union\\\" - Person is in a civil union.\"},\"tagline\":" +
            "{\"type\":\"string\",\"description\":\"The brief description (tagline) of this person.\"" +
            "},\"url\":{\"type\":\"string\",\"description\":\"The URL of this person\'s profile.\"},\"url" +
            "s\":{\"type\":\"array\",\"description\":\"A list of URLs for this person.\",\"items\":{\"typ" +
            "e\":\"object\",\"properties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\"" +
            ", this URL is the person\'s primary URL.\"},\"type\":{\"type\":\"string\",\"description\":" +
            "\"The type of URL. Possible values are:  \\n- \\\"home\\\" - URL for home. \\n- \\\"work\\" +
            "\" - URL for work. \\n- \\\"blog\\\" - URL for blog. \\n- \\\"profile\\\" - URL for profile" +
            ". \\n- \\\"other\\\" - Other.\"},\"value\":{\"type\":\"string\",\"description\":\"The URL value" +
            ".\"}}}},\"verified\":{\"type\":\"boolean\",\"description\":\"If a Google+ Page, whether it" +
            " has been verified.\"}}},\"PlusAclentryResource\":{\"id\":\"PlusAclentryResource\",\"typ" +
            "e\":\"object\",\"properties\":{\"displayName\":{\"type\":\"string\",\"description\":\"A descri" +
            "ptive name for this entry. Suitable for display.\"},\"id\":{\"type\":\"string\",\"descri" +
            "ption\":\"The ID of the entry. For entries of type \\\"person\\\" or \\\"circle\\\", this " +
            "is the ID of the resource. For other types, this property is not set.\"},\"type\":{" +
            "\"type\":\"string\",\"description\":\"The type of entry describing to whom access is gr" +
            "anted. Possible values are:  \\n- \\\"person\\\" - Access to an individual. \\n- \\\"cir" +
            "cle\\\" - Access to members of a circle. \\n- \\\"myCircles\\\" - Access to members of " +
            "all the person\'s circles. \\n- \\\"extendedCircles\\\" - Access to members of everyon" +
            "e in a person\'s circles, plus all of the people in their circles. \\n- \\\"public\\\"" +
            " - Access to anyone on the web.\"}}}},\"resources\":{\"activities\":{\"methods\":{\"get\"" +
            ":{\"id\":\"plus.activities.get\",\"path\":\"activities/{activityId}\",\"httpMethod\":\"GET\"" +
            ",\"description\":\"Get an activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"d" +
            "escription\":\"The ID of the activity to get.\",\"required\":true,\"location\":\"path\"}}" +
            ",\"parameterOrder\":[\"activityId\"],\"response\":{\"$ref\":\"Activity\"},\"scopes\":[\"https" +
            "://www.googleapis.com/auth/plus.me\"]},\"list\":{\"id\":\"plus.activities.list\",\"path\"" +
            ":\"people/{userId}/activities/{collection}\",\"httpMethod\":\"GET\",\"description\":\"Lis" +
            "t all of the activities in the specified collection for a particular user.\",\"par" +
            "ameters\":{\"collection\":{\"type\":\"string\",\"description\":\"The collection of activit" +
            "ies to list.\",\"required\":true,\"enum\":[\"public\"],\"enumDescriptions\":[\"All public " +
            "activities created by the specified user.\"],\"location\":\"path\"},\"maxResults\":{\"ty" +
            "pe\":\"integer\",\"description\":\"The maximum number of activities to include in the " +
            "response, which is used for paging. For any response, the actual number returned" +
            " might be less than the specified maxResults.\",\"default\":\"20\",\"format\":\"uint32\"," +
            ...
            "ue \\\"me\\\" can be used to indicate the authenticated user.\",\"required\":true,\"loca" +
            "tion\":\"path\"}},\"parameterOrder\":[\"userId\",\"collection\"],\"response\":{\"$ref\":\"Acti" +
            "vityFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"search\":{\"id\":" +
            "\"plus.activities.search\",\"path\":\"activities\",\"httpMethod\":\"GET\",\"description\":\"S" +
            "earch public activities.\",\"parameters\":{\"language\":{\"type\":\"string\",\"description" +
            "\":\"Specify the preferred language to search with. See search language codes for " +
            "available values.\",\"default\":\"en-US\",\"location\":\"query\"},\"maxResults\":{\"type\":\"i" +
            "nteger\",\"description\":\"The maximum number of activities to include in the respon" +
            "se, which is used for paging. For any response, the actual number returned might" +
            " be less than the specified maxResults.\",\"default\":\"10\",\"format\":\"uint32\",\"minim" +
            "um\":\"1\",\"maximum\":\"20\",\"location\":\"query\"},\"orderBy\":{\"type\":\"string\",\"descripti" +
            "on\":\"Specifies how to order search results.\",\"default\":\"recent\",\"enum\":[\"best\",\"" +
            "recent\"],\"enumDescriptions\":[\"Sort activities by relevance to the user, most rel" +
            "evant first.\",\"Sort activities by published date, most recent first.\"],\"location" +
            ...
            ". This token can be of any length.\",\"location\":\"query\"},\"query\":{\"type\":\"string\"" +
            ",\"description\":\"Full-text search query string.\",\"required\":true,\"location\":\"quer" +
            "y\"}},\"parameterOrder\":[\"query\"],\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[\"ht" +
            "tps://www.googleapis.com/auth/plus.me\"]}}},\"comments\":{\"methods\":{\"get\":{\"id\":\"p" +
            "lus.comments.get\",\"path\":\"comments/{commentId}\",\"httpMethod\":\"GET\",\"description\"" +
            ":\"Get a comment.\",\"parameters\":{\"commentId\":{\"type\":\"string\",\"description\":\"The " +
            "ID of the comment to get.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":" +
            "[\"commentId\"],\"response\":{\"$ref\":\"Comment\"},\"scopes\":[\"https://www.googleapis.co" +
            "m/auth/plus.me\"]},\"list\":{\"id\":\"plus.comments.list\",\"path\":\"activities/{activity" +
            "Id}/comments\",\"httpMethod\":\"GET\",\"description\":\"List all of the comments for an " +
            "activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"description\":\"The ID of " +
            "the activity to get comments for.\",\"required\":true,\"location\":\"path\"},\"maxResult" +
            "s\":{\"type\":\"integer\",\"description\":\"The maximum number of comments to include in" +
            " the response, which is used for paging. For any response, the actual number ret" +
            "urned might be less than the specified maxResults.\",\"default\":\"20\",\"format\":\"uin" +
            "t32\",\"minimum\":\"0\",\"maximum\":\"500\",\"location\":\"query\"},\"pageToken\":{\"type\":\"stri" +
            "ng\",\"description\":\"The continuation token, which is used to page through large r" +
            "esult sets. To get the next page of results, set this parameter to the value of " +
            "\\\"nextPageToken\\\" from the previous response.\",\"location\":\"query\"},\"sortOrder\":{" +
            "\"type\":\"string\",\"description\":\"The order in which to sort the list of comments.\"" +
            ",\"default\":\"ascending\",\"enum\":[\"ascending\",\"descending\"],\"enumDescriptions\":[\"So" +
            "rt oldest comments first.\",\"Sort newest comments first.\"],\"location\":\"query\"}},\"" +
            "parameterOrder\":[\"activityId\"],\"response\":{\"$ref\":\"CommentFeed\"},\"scopes\":[\"http" +
            "s://www.googleapis.com/auth/plus.me\"]}}},\"people\":{\"methods\":{\"get\":{\"id\":\"plus." +
            "people.get\",\"path\":\"people/{userId}\",\"httpMethod\":\"GET\",\"description\":\"Get a per" +
            "son\'s profile.\",\"parameters\":{\"userId\":{\"type\":\"string\",\"description\":\"The ID of" +
            " the person to get the profile for. The special value \\\"me\\\" can be used to indi" +
            "cate the authenticated user.\",\"required\":true,\"location\":\"path\"}},\"parameterOrde" +
            "r\":[\"userId\"],\"response\":{\"$ref\":\"Person\"},\"scopes\":[\"https://www.googleapis.com" +
            "/auth/plus.me\"]},\"listByActivity\":{\"id\":\"plus.people.listByActivity\",\"path\":\"act" +
            "ivities/{activityId}/people/{collection}\",\"httpMethod\":\"GET\",\"description\":\"List" +
            " all of the people in the specified collection for a particular activity.\",\"para" +
            "meters\":{\"activityId\":{\"type\":\"string\",\"description\":\"The ID of the activity to " +
            "get the list of people for.\",\"required\":true,\"location\":\"path\"},\"collection\":{\"t" +
            "ype\":\"string\",\"description\":\"The collection of people to list.\",\"required\":true," +
            "\"enum\":[\"plusoners\",\"resharers\"],\"enumDescriptions\":[\"List all people who have +" +
            "1\'d this activity.\",\"List all people who have reshared this activity.\"],\"locatio" +
            "n\":\"path\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The maximum number of p" +
            "eople to include in the response, which is used for paging. For any response, th" +
            "e actual number returned might be less than the specified maxResults.\",\"default\"" +
            ":\"20\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"100\",\"location\":\"query\"},\"pageT" +
            "oken\":{\"type\":\"string\",\"description\":\"The continuation token, which is used to p" +
            "age through large result sets. To get the next page of results, set this paramet" +
            "er to the value of \\\"nextPageToken\\\" from the previous response.\",\"location\":\"qu" +
            "ery\"}},\"parameterOrder\":[\"activityId\",\"collection\"],\"response\":{\"$ref\":\"PeopleFe" +
            "ed\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"search\":{\"id\":\"plus." +
            "people.search\",\"path\":\"people\",\"httpMethod\":\"GET\",\"description\":\"Search all publ" +
            "ic profiles.\",\"parameters\":{\"language\":{\"type\":\"string\",\"description\":\"Specify t" +
            "he preferred language to search with. See search language codes for available va" +
            "lues.\",\"default\":\"en-US\",\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"des" +
            "cription\":\"The maximum number of people to include in the response, which is use" +
            "d for paging. For any response, the actual number returned might be less than th" +
            "e specified maxResults.\",\"default\":\"10\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum" +
            "\":\"20\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The conti" +
            "nuation token, which is used to page through large result sets. To get the next " +
            "page of results, set this parameter to the value of \\\"nextPageToken\\\" from the p" +
            "revious response. This token can be of any length.\",\"location\":\"query\"},\"query\":" +
            "{\"type\":\"string\",\"description\":\"Specify a query string for full text search of p" +
            "ublic text in all profiles.\",\"required\":true,\"location\":\"query\"}},\"parameterOrde" +
            "r\":[\"query\"],\"response\":{\"$ref\":\"PeopleFeed\"},\"scopes\":[\"https://www.googleapis." +
            "com/auth/plus.me\"]}}}}}";
