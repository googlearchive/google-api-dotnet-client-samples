...
namespace Google.Apis.Plus.v1 {
    ...
    public partial class PlusService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"etag\":\"\\\"oZqOFf-aKzMvpID-BwBAFJLe7Pk/cghvIem" +
            "5k7Idgs79-JvY26k5X60\\\"\",\"discoveryVersion\":\"v1\",\"id\":\"plus:v1\",\"name\":\"plus\",\"ve" +
            "rsion\":\"v1\",\"revision\":\"20121022\",\"title\":\"Google+ API\",\"description\":\"The Googl" +
            ...
            " action was performed. Possible values are:  \\n- \\\"post\\\" - Publish content to t" +
            "he stream. \\n- \\\"share\\\" - Reshare an activity.\"}}},\"ActivityFeed\":{\"id\":\"Activi" +
            "tyFeed\",\"type\":\"object\",\"properties\":{\"etag\":{\"type\":\"string\",\"description\":\"ETa" +
            "g of this response for caching purposes.\"},\"id\":{\"type\":\"string\",\"description\":\"" +
            "The ID of this collection of activities.\"},\"items\":{\"type\":\"array\",\"description\"" +
            ":\"The activities in this page of results.\",\"items\":{\"$ref\":\"Activity\"}},\"kind\":{" +
            "\"type\":\"string\",\"description\":\"Identifies this resource as a collection of activ" +
            "ities. Value: \\\"plus#activityFeed\\\".\",\"default\":\"plus#activityFeed\"},\"nextLink\":" +
            ...
            "turn the next page of results.\"},\"selfLink\":{\"type\":\"string\",\"description\":\"Link" +
            " to this activity resource.\"},\"title\":{\"type\":\"string\",\"description\":\"The title " +
            "of this collection of activities.\"},\"updated\":{\"type\":\"string\",\"description\":\"Th" +
            "e time at which this collection of activities was last updated. Formatted as an " +
            "RFC 3339 timestamp.\",\"format\":\"date-time\"}}},\"Comment\":{\"id\":\"Comment\",\"type\":\"o" +
            "bject\",\"properties\":{\"actor\":{\"type\":\"object\",\"description\":\"The person who post" +
            "ed this comment.\",\"properties\":{\"displayName\":{\"type\":\"string\",\"description\":\"Th" +
            "e name of this actor, suitable for display.\"},\"id\":{\"type\":\"string\",\"description" +
            "\":\"The ID of the actor.\"},\"image\":{\"type\":\"object\",\"description\":\"The image repr" +
            "esentation of this actor.\",\"properties\":{\"url\":{\"type\":\"string\",\"description\":\"T" +
            ...
            "e.\"}}},\"url\":{\"type\":\"string\",\"description\":\"A link to the person resource for t" +
            "his actor.\"}}},\"etag\":{\"type\":\"string\",\"description\":\"ETag of this response for " +
            "caching purposes.\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of this comment." +
            "\"},\"inReplyTo\":{\"type\":\"array\",\"description\":\"The activity this comment replied " +
            "to.\",\"items\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\",\"description\":" +
            "\"The ID of the activity.\"},\"url\":{\"type\":\"string\",\"description\":\"The URL of the " +
            "activity.\"}}}},\"kind\":{\"type\":\"string\",\"description\":\"Identifies this resource a" +
            "s a comment. Value: \\\"plus#comment\\\".\",\"default\":\"plus#comment\"},\"object\":{\"type" +
            "\":\"object\",\"description\":\"The object of this comment.\",\"properties\":{\"content\":{" +
            "\"type\":\"string\",\"description\":\"The HTML-formatted content, suitable for display." +
            "\"},\"objectType\":{\"type\":\"string\",\"description\":\"The object type of this comment." +
            " Possible values are:  \\n- \\\"comment\\\" - A comment in reply to an activity.\",\"de" +
            "fault\":\"comment\"},\"originalContent\":{\"type\":\"string\",\"description\":\"The content " +
            "(text) as provided by the author, stored without any HTML formatting. When creat" +
            "ing or updating a comment, this value must be supplied as plain text in the requ" +
            "est.\"}}},\"plusoners\":{\"type\":\"object\",\"description\":\"People who +1\'d this commen" +
            "t.\",\"properties\":{\"totalItems\":{\"type\":\"integer\",\"description\":\"Total number of " +
            "people who +1\'d this comment.\",\"format\":\"uint32\"}}},\"published\":{\"type\":\"string\"" +
            ",\"description\":\"The time at which this comment was initially published. Formatte" +
            "d as an RFC 3339 timestamp.\",\"format\":\"date-time\"},\"selfLink\":{\"type\":\"string\",\"" +
            "description\":\"Link to this comment resource.\"},\"updated\":{\"type\":\"string\",\"descr" +
            "iption\":\"The time at which this comment was last updated. Formatted as an RFC 33" +
            "39 timestamp.\",\"format\":\"date-time\"},\"verb\":{\"type\":\"string\",\"description\":\"This" +
            " comment\'s verb, indicating what action was performed. Possible values are:  \\n-" +
            " \\\"post\\\" - Publish content to the stream.\",\"default\":\"post\"}}},\"CommentFeed\":{\"" +
            "id\":\"CommentFeed\",\"type\":\"object\",\"properties\":{\"etag\":{\"type\":\"string\",\"descrip" +
            "tion\":\"ETag of this response for caching purposes.\"},\"id\":{\"type\":\"string\",\"desc" +
            "ription\":\"The ID of this collection of comments.\"},\"items\":{\"type\":\"array\",\"desc" +
            "ription\":\"The comments in this page of results.\",\"items\":{\"$ref\":\"Comment\"}},\"ki" +
            "nd\":{\"type\":\"string\",\"description\":\"Identifies this resource as a collection of " +
            "comments. Value: \\\"plus#commentFeed\\\".\",\"default\":\"plus#commentFeed\"},\"nextLink\"" +
            ":{\"type\":\"string\",\"description\":\"Link to the next page of activities.\"},\"nextPag" +
            ...
            "eturn the next page of results.\"},\"title\":{\"type\":\"string\",\"description\":\"The ti" +
            "tle of this collection of comments.\"},\"updated\":{\"type\":\"string\",\"description\":\"" +
            "The time at which this collection of comments was last updated. Formatted as an " +
            "RFC 3339 timestamp.\",\"format\":\"date-time\"}}},\"PeopleFeed\":{\"id\":\"PeopleFeed\",\"ty" +
            "pe\":\"object\",\"properties\":{\"etag\":{\"type\":\"string\",\"description\":\"ETag of this r" +
            "esponse for caching purposes.\"},\"items\":{\"type\":\"array\",\"description\":\"The peopl" +
            "e in this page of results. Each item includes the id, displayName, image, and ur" +
            "l for the person. To retrieve additional profile data, see the people.get method" +
            ".\",\"items\":{\"$ref\":\"Person\"}},\"kind\":{\"type\":\"string\",\"description\":\"Identifies " +
            "this resource as a collection of people. Value: \\\"plus#peopleFeed\\\".\",\"default\":" +
            "\"plus#peopleFeed\"},\"nextPageToken\":{\"type\":\"string\",\"description\":\"The continuat" +
            "ion token, which is used to page through large result sets. Provide this value i" +
            "n a subsequent request to return the next page of results.\"},\"selfLink\":{\"type\":" +
            "\"string\",\"description\":\"Link to this resource.\"},\"title\":{\"type\":\"string\",\"descr" +
            "iption\":\"The title of this collection of people.\"},\"totalItems\":{\"type\":\"integer" +
            "\",\"description\":\"The total number of people available in this list. The number o" +
            "f people in a response might be smaller due to paging. This might not be set for" +
            " all collections.\",\"format\":\"int32\"}}},\"Person\":{\"id\":\"Person\",\"type\":\"object\",\"" +
            "properties\":{\"aboutMe\":{\"type\":\"string\",\"description\":\"A short biography for thi" +
            "s person.\"},\"birthday\":{\"type\":\"string\",\"description\":\"The person\'s date of birt" +
            "h, represented as YYYY-MM-DD.\"},\"currentLocation\":{\"type\":\"string\",\"description\"" +
            ":\"The current location for this person.\"},\"displayName\":{\"type\":\"string\",\"descri" +
            "ption\":\"The name of this person, suitable for display.\"},\"emails\":{\"type\":\"array" +
            "\",\"description\":\"A list of email addresses for this person.\",\"items\":{\"type\":\"ob" +
            "ject\",\"properties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", indi" +
            "cates this email address is the person\'s primary one.\"},\"type\":{\"type\":\"string\"," +
            "\"description\":\"The type of address. Possible values are:  \\n- \\\"home\\\" - Home em" +
            "ail address. \\n- \\\"work\\\" - Work email address. \\n- \\\"other\\\" - Other.\"},\"value\"" +
            ":{\"type\":\"string\",\"description\":\"The email address.\"}}}},\"etag\":{\"type\":\"string\"" +
            ",\"description\":\"ETag of this response for caching purposes.\"},\"gender\":{\"type\":\"" +
            "string\",\"description\":\"The person\'s gender. Possible values are:  \\n- \\\"male\\\" -" +
            " Male gender. \\n- \\\"female\\\" - Female gender. \\n- \\\"other\\\" - Other.\"},\"hasApp\":" +
            "{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", indicates that the person has inst" +
            "alled the app that is making the request and has chosen to expose this install s" +
            "tate to the caller. A value of \\\"false\\\" indicates that the install state cannot" +
            " be determined (it is either not installed or the person has chosen to keep this" +
            " information private).\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of this per" +
            "son.\"},\"image\":{\"type\":\"object\",\"description\":\"The representation of the person\'" +
            "s profile photo.\",\"properties\":{\"url\":{\"type\":\"string\",\"description\":\"The URL of" +
            " the person\'s profile photo. To re-size the image and crop it to a square, appen" +
            "d the query string ?sz=x, where x is the dimension in pixels of each side.\"}}},\"" +
            "isPlusUser\":{\"type\":\"boolean\",\"description\":\"Whether this user has signed up for" +
            " G+.\"},\"kind\":{\"type\":\"string\",\"description\":\"Identifies this resource as a pers" +
            "on. Value: \\\"plus#person\\\".\",\"default\":\"plus#person\"},\"name\":{\"type\":\"object\",\"d" +
            "escription\":\"An object representation of the individual components of a person\'s" +
            " name.\",\"properties\":{\"familyName\":{\"type\":\"string\",\"description\":\"The family na" +
            "me (last name) of this person.\"},\"formatted\":{\"type\":\"string\",\"description\":\"The" +
            " full name of this person, including middle names, suffixes, etc.\"},\"givenName\":" +
            "{\"type\":\"string\",\"description\":\"The given name (first name) of this person.\"},\"h" +
            "onorificPrefix\":{\"type\":\"string\",\"description\":\"The honorific prefixes (such as " +
            "\\\"Dr.\\\" or \\\"Mrs.\\\") for this person.\"},\"honorificSuffix\":{\"type\":\"string\",\"desc" +
            "ription\":\"The honorific suffixes (such as \\\"Jr.\\\") for this person.\"},\"middleNam" +
            "e\":{\"type\":\"string\",\"description\":\"The middle name of this person.\"}}},\"nickname" +
            "\":{\"type\":\"string\",\"description\":\"The nickname of this person.\"},\"objectType\":{\"" +
            "type\":\"string\",\"description\":\"Type of person within Google+. Possible values are" +
            ":  \\n- \\\"person\\\" - represents an actual person. \\n- \\\"page\\\" - represents a pag" +
            "e.\"},\"organizations\":{\"type\":\"array\",\"description\":\"A list of current or past or" +
            "ganizations with which this person is associated.\",\"items\":{\"type\":\"object\",\"pro" +
            "perties\":{\"department\":{\"type\":\"string\",\"description\":\"The department within the" +
            " organization. Deprecated.\"},\"description\":{\"type\":\"string\",\"description\":\"A sho" +
            "rt description of the person\'s role in this organization. Deprecated.\"},\"endDate" +
            "\":{\"type\":\"string\",\"description\":\"The date the person left this organization.\"}," +
            "\"location\":{\"type\":\"string\",\"description\":\"The location of this organization. De" +
            "precated.\"},\"name\":{\"type\":\"string\",\"description\":\"The name of the organization." +
            "\"},\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", indicates this organi" +
            "zation is the person\'s primary one (typically interpreted as current one).\"},\"st" +
            "artDate\":{\"type\":\"string\",\"description\":\"The date the person joined this organiz" +
            "ation.\"},\"title\":{\"type\":\"string\",\"description\":\"The person\'s job title or role " +
            "within the organization.\"},\"type\":{\"type\":\"string\",\"description\":\"The type of or" +
            "ganization. Possible values are:  \\n- \\\"work\\\" - Work. \\n- \\\"school\\\" - School.\"" +
            "}}}},\"placesLived\":{\"type\":\"array\",\"description\":\"A list of places where this pe" +
            "rson has lived.\",\"items\":{\"type\":\"object\",\"properties\":{\"primary\":{\"type\":\"boole" +
            "an\",\"description\":\"If \\\"true\\\", this place of residence is this person\'s primary" +
            " residence.\"},\"value\":{\"type\":\"string\",\"description\":\"A place where this person " +
            "has lived. For example: \\\"Seattle, WA\\\", \\\"Near Toronto\\\".\"}}}},\"relationshipSta" +
            "tus\":{\"type\":\"string\",\"description\":\"The person\'s relationship status. Possible " +
            "values are:  \\n- \\\"single\\\" - Person is single. \\n- \\\"in_a_relationship\\\" - Pers" +
            "on is in a relationship. \\n- \\\"engaged\\\" - Person is engaged. \\n- \\\"married\\\" - " +
            "Person is married. \\n- \\\"its_complicated\\\" - The relationship is complicated. \\n" +
            "- \\\"open_relationship\\\" - Person is in an open relationship. \\n- \\\"widowed\\\" - P" +
            "erson is widowed. \\n- \\\"in_domestic_partnership\\\" - Person is in a domestic part" +
            "nership. \\n- \\\"in_civil_union\\\" - Person is in a civil union.\"},\"tagline\":{\"type" +
            "\":\"string\",\"description\":\"The brief description (tagline) of this person.\"},\"url" +
            "\":{\"type\":\"string\",\"description\":\"The URL of this person\'s profile.\"},\"urls\":{\"t" +
            "ype\":\"array\",\"description\":\"A list of URLs for this person.\",\"items\":{\"type\":\"ob" +
            "ject\",\"properties\":{\"primary\":{\"type\":\"boolean\",\"description\":\"If \\\"true\\\", this" +
            " URL is the person\'s primary URL.\"},\"type\":{\"type\":\"string\",\"description\":\"The t" +
            "ype of URL. Possible values are:  \\n- \\\"home\\\" - URL for home. \\n- \\\"work\\\" - UR" +
            "L for work. \\n- \\\"blog\\\" - URL for blog. \\n- \\\"profile\\\" - URL for profile. \\n- " +
            "\\\"other\\\" - Other.\"},\"value\":{\"type\":\"string\",\"description\":\"The URL value.\"}}}}" +
            "}},\"PlusAclentryResource\":{\"id\":\"PlusAclentryResource\",\"type\":\"object\",\"properti" +
            "es\":{\"displayName\":{\"type\":\"string\",\"description\":\"A descriptive name for this e" +
            "ntry. Suitable for display.\"},\"id\":{\"type\":\"string\",\"description\":\"The ID of the" +
            " entry. For entries of type \\\"person\\\" or \\\"circle\\\", this is the ID of the reso" +
            "urce. For other types, this property is not set.\"},\"type\":{\"type\":\"string\",\"desc" +
            "ription\":\"The type of entry describing to whom access is granted. Possible value" +
            "s are:  \\n- \\\"person\\\" - Access to an individual. \\n- \\\"circle\\\" - Access to mem" +
            "bers of a circle. \\n- \\\"myCircles\\\" - Access to members of all the person\'s circ" +
            "les. \\n- \\\"extendedCircles\\\" - Access to members of everyone in a person\'s circl" +
            "es, plus all of the people in their circles. \\n- \\\"public\\\" - Access to anyone o" +
            "n the web.\"}}}},\"resources\":{\"activities\":{\"methods\":{\"get\":{\"id\":\"plus.activiti" +
            "es.get\",\"path\":\"activities/{activityId}\",\"httpMethod\":\"GET\",\"description\":\"Get a" +
            "n activity.\",\"parameters\":{\"activityId\":{\"type\":\"string\",\"description\":\"The ID o" +
            "f the activity to get.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"a" +
            "ctivityId\"],\"response\":{\"$ref\":\"Activity\"},\"scopes\":[\"https://www.googleapis.com" +
            "/auth/plus.me\"]},\"list\":{\"id\":\"plus.activities.list\",\"path\":\"people/{userId}/act" +
            "ivities/{collection}\",\"httpMethod\":\"GET\",\"description\":\"List all of the activiti" +
            "es in the specified collection for a particular user.\",\"parameters\":{\"collection" +
            "\":{\"type\":\"string\",\"description\":\"The collection of activities to list.\",\"requir" +
            "ed\":true,\"enum\":[\"public\"],\"enumDescriptions\":[\"All public activities created by" +
            " the specified user.\"],\"location\":\"path\"},\"maxResults\":{\"type\":\"integer\",\"descri" +
            "ption\":\"The maximum number of activities to include in the response, which is us" +
            "ed for paging. For any response, the actual number returned might be less than t" +
            "he specified maxResults.\",\"default\":\"20\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximu" +
            "m\":\"100\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The con" +
            "tinuation token, which is used to page through large result sets. To get the nex" +
            "t page of results, set this parameter to the value of \\\"nextPageToken\\\" from the" +
            " previous response.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"description\"" +
            ":\"The ID of the user to get activities for. The special value \\\"me\\\" can be used" +
            " to indicate the authenticated user.\",\"required\":true,\"location\":\"path\"}},\"param" +
            "eterOrder\":[\"userId\",\"collection\"],\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[" +
            "\"https://www.googleapis.com/auth/plus.me\"]},\"search\":{\"id\":\"plus.activities.sear" +
            "ch\",\"path\":\"activities\",\"httpMethod\":\"GET\",\"description\":\"Search public activiti" +
            "es.\",\"parameters\":{\"language\":{\"type\":\"string\",\"description\":\"Specify the prefer" +
            "red language to search with. See search language codes for available values.\",\"d" +
            "efault\":\"\",\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The" +
            " maximum number of activities to include in the response, which is used for pagi" +
            "ng. For any response, the actual number returned might be less than the specifie" +
            "d maxResults.\",\"default\":\"10\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"20\",\"lo" +
            "cation\":\"query\"},\"orderBy\":{\"type\":\"string\",\"description\":\"Specifies how to orde" +
            "r search results.\",\"default\":\"recent\",\"enum\":[\"best\",\"recent\"],\"enumDescriptions" +
            "\":[\"Sort activities by relevance to the user, most relevant first.\",\"Sort activi" +
            "ties by published date, most recent first.\"],\"location\":\"query\"},\"pageToken\":{\"t" +
            ...
            " value of \\\"nextPageToken\\\" from the previous response. This token can be of any" +
            " length.\",\"location\":\"query\"},\"query\":{\"type\":\"string\",\"description\":\"Full-text " +
            "search query string.\",\"required\":true,\"location\":\"query\"}},\"parameterOrder\":[\"qu" +
            "ery\"],\"response\":{\"$ref\":\"ActivityFeed\"},\"scopes\":[\"https://www.googleapis.com/a" +
            "uth/plus.me\"]}}},\"comments\":{\"methods\":{\"get\":{\"id\":\"plus.comments.get\",\"path\":\"" +
            "comments/{commentId}\",\"httpMethod\":\"GET\",\"description\":\"Get a comment.\",\"paramet" +
            "ers\":{\"commentId\":{\"type\":\"string\",\"description\":\"The ID of the comment to get.\"" +
            ",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"commentId\"],\"response\":{" +
            "\"$ref\":\"Comment\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"list\":{" +
            "\"id\":\"plus.comments.list\",\"path\":\"activities/{activityId}/comments\",\"httpMethod\"" +
            ":\"GET\",\"description\":\"List all of the comments for an activity.\",\"parameters\":{\"" +
            "activityId\":{\"type\":\"string\",\"description\":\"The ID of the activity to get commen" +
            "ts for.\",\"required\":true,\"location\":\"path\"},\"maxResults\":{\"type\":\"integer\",\"desc" +
            "ription\":\"The maximum number of comments to include in the response, which is us" +
            "ed for paging. For any response, the actual number returned might be less than t" +
            "he specified maxResults.\",\"default\":\"20\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximu" +
            "m\":\"500\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The con" +
            "tinuation token, which is used to page through large result sets. To get the nex" +
            "t page of results, set this parameter to the value of \\\"nextPageToken\\\" from the" +
            " previous response.\",\"location\":\"query\"},\"sortOrder\":{\"type\":\"string\",\"descripti" +
            "on\":\"The order in which to sort the list of comments.\",\"default\":\"ascending\",\"en" +
            "um\":[\"ascending\",\"descending\"],\"enumDescriptions\":[\"Sort oldest comments first.\"" +
            ",\"Sort newest comments first.\"],\"location\":\"query\"}},\"parameterOrder\":[\"activity" +
            "Id\"],\"response\":{\"$ref\":\"CommentFeed\"},\"scopes\":[\"https://www.googleapis.com/aut" +
            "h/plus.me\"]}}},\"people\":{\"methods\":{\"get\":{\"id\":\"plus.people.get\",\"path\":\"people" +
            "/{userId}\",\"httpMethod\":\"GET\",\"description\":\"Get a person\'s profile.\",\"parameter" +
            "s\":{\"userId\":{\"type\":\"string\",\"description\":\"The ID of the person to get the pro" +
            "file for. The special value \\\"me\\\" can be used to indicate the authenticated use" +
            "r.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"userId\"],\"response\":{" +
            "\"$ref\":\"Person\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]},\"listByAc" +
            "tivity\":{\"id\":\"plus.people.listByActivity\",\"path\":\"activities/{activityId}/peopl" +
            "e/{collection}\",\"httpMethod\":\"GET\",\"description\":\"List all of the people in the " +
            "specified collection for a particular activity.\",\"parameters\":{\"activityId\":{\"ty" +
            "pe\":\"string\",\"description\":\"The ID of the activity to get the list of people for" +
            ".\",\"required\":true,\"location\":\"path\"},\"collection\":{\"type\":\"string\",\"description" +
            "\":\"The collection of people to list.\",\"required\":true,\"enum\":[\"plusoners\",\"resha" +
            "rers\"],\"enumDescriptions\":[\"List all people who have +1\'d this activity.\",\"List " +
            "all people who have reshared this activity.\"],\"location\":\"path\"},\"maxResults\":{\"" +
            "type\":\"integer\",\"description\":\"The maximum number of people to include in the re" +
            "sponse, which is used for paging. For any response, the actual number returned m" +
            "ight be less than the specified maxResults.\",\"default\":\"20\",\"format\":\"uint32\",\"m" +
            "inimum\":\"1\",\"maximum\":\"100\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"de" +
            ...
            "activityId\",\"collection\"],\"response\":{\"$ref\":\"PeopleFeed\"},\"scopes\":[\"https://ww" +
            "w.googleapis.com/auth/plus.me\"]},\"search\":{\"id\":\"plus.people.search\",\"path\":\"peo" +
            "ple\",\"httpMethod\":\"GET\",\"description\":\"Search all public profiles.\",\"parameters\"" +
            ":{\"language\":{\"type\":\"string\",\"description\":\"Specify the preferred language to s" +
            "earch with. See search language codes for available values.\",\"default\":\"\",\"locat" +
            "ion\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"The maximum number o" +
            "f people to include in the response, which is used for paging. For any response," +
            " the actual number returned might be less than the specified maxResults.\",\"defau" +
            "lt\":\"10\",\"format\":\"uint32\",\"minimum\":\"1\",\"maximum\":\"20\",\"location\":\"query\"},\"pag" +
            "eToken\":{\"type\":\"string\",\"description\":\"The continuation token, which is used to" +
            " page through large result sets. To get the next page of results, set this param" +
            "eter to the value of \\\"nextPageToken\\\" from the previous response. This token ca" +
            "n be of any length.\",\"location\":\"query\"},\"query\":{\"type\":\"string\",\"description\":" +
            "\"Specify a query string for full text search of public text in all profiles.\",\"r" +
            "equired\":true,\"location\":\"query\"}},\"parameterOrder\":[\"query\"],\"response\":{\"$ref\"" +
            ":\"PeopleFeed\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\"]}}}}}";
