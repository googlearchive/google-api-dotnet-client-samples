...
namespace Google.Apis.Books.v1 {
    ...
    public partial class BooksService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"discoveryVersion\":\"v1\",\"id\":\"books:v1\",\"name" +
            "\":\"books\",\"version\":\"v1\",\"revision\":\"20120614\",\"title\":\"Books API\",\"description\"" +
            ...
            "NRESTRICTED, RESTRICTED, NEVER\"},\"countryCode\":{\"type\":\"string\",\"description\":\"T" +
            "he country code of the location.\"},\"latitude\":{\"type\":\"number\",\"description\":\"Th" +
            "e latitude of the location.\",\"format\":\"double\"},\"longitude\":{\"type\":\"number\",\"de" +
            "scription\":\"The longitude of the location.\",\"format\":\"double\"},\"mapType\":{\"type\"" +
            ":\"string\",\"description\":\"The type of map that should be used for this location. " +
            "EX: HYBRID, ROADMAP, SATELLITE, TERRAIN\"},\"resolution\":{\"type\":\"string\",\"descrip" +
            "tion\":\"The resolution of the location. Ex: POI_LEVEL\"},\"viewport\":{\"type\":\"objec" +
            "t\",\"description\":\"The viewport for showing this location. This is a latitude, lo" +
            "ngitude rectangle.\",\"properties\":{\"hi\":{\"type\":\"object\",\"properties\":{\"latitude\"" +
            ":{\"type\":\"number\",\"format\":\"double\"},\"longitude\":{\"type\":\"number\",\"format\":\"doub" +
            "le\"}}},\"lo\":{\"type\":\"object\",\"properties\":{\"latitude\":{\"type\":\"number\",\"format\":" +
            "\"double\"},\"longitude\":{\"type\":\"number\",\"format\":\"double\"}}}}},\"zoom\":{\"type\":\"in" +
            "teger\",\"description\":\"The Zoom level to use for the map. Zoom levels between 0 (" +
            "the lowest zoom level, in which the entire world can be seen on one map) to 21+ " +
            "(down to individual buildings). See: https://developers.google.com/maps/document" +
            "ation/staticmaps/#Zoomlevels\",\"format\":\"int32\"}}}}},\"Bookshelf\":{\"id\":\"Bookshelf" +
            "\",\"type\":\"object\",\"properties\":{\"access\":{\"type\":\"string\",\"description\":\"Whether" +
            " this bookshelf is PUBLIC or PRIVATE.\"},\"created\":{\"type\":\"string\",\"description\"" +
            ":\"Created time for this bookshelf (formatted UTC timestamp with millisecond reso" +
            "lution).\",\"format\":\"date-time\"},\"description\":{\"type\":\"string\",\"description\":\"De" +
            "scription of this bookshelf.\"},\"id\":{\"type\":\"integer\",\"description\":\"Id of this " +
            "bookshelf, only unique by user.\",\"format\":\"int32\"},\"kind\":{\"type\":\"string\",\"desc" +
            "ription\":\"Resource type for bookshelf metadata.\",\"default\":\"books#bookshelf\"},\"s" +
            "elfLink\":{\"type\":\"string\",\"description\":\"URL to this resource.\"},\"title\":{\"type\"" +
            ":\"string\",\"description\":\"Title of this bookshelf.\"},\"updated\":{\"type\":\"string\",\"" +
            "description\":\"Last modified time of this bookshelf (formatted UTC timestamp with" +
            " millisecond resolution).\",\"format\":\"date-time\"},\"volumeCount\":{\"type\":\"integer\"" +
            ",\"description\":\"Number of volumes in this bookshelf.\",\"format\":\"int32\"},\"volumes" +
            "LastUpdated\":{\"type\":\"string\",\"description\":\"Last time a volume was added or rem" +
            "oved from this bookshelf (formatted UTC timestamp with millisecond resolution).\"" +
            ",\"format\":\"date-time\"}}},\"Bookshelves\":{\"id\":\"Bookshelves\",\"type\":\"object\",\"prop" +
            "erties\":{\"items\":{\"type\":\"array\",\"description\":\"A list of bookshelves.\",\"items\":" +
            "{\"$ref\":\"Bookshelf\"}},\"kind\":{\"type\":\"string\",\"description\":\"Resource type.\",\"de" +
            "fault\":\"books#bookshelves\"}}},\"ConcurrentAccessRestriction\":{\"id\":\"ConcurrentAcc" +
            "essRestriction\",\"type\":\"object\",\"properties\":{\"deviceAllowed\":{\"type\":\"boolean\"," +
            "\"description\":\"Whether access is granted for this (user, device, volume).\"},\"kin" +
            "d\":{\"type\":\"string\",\"description\":\"Resource type.\",\"default\":\"books#concurrentAc" +
            "cessRestriction\"},\"maxConcurrentDevices\":{\"type\":\"integer\",\"description\":\"The ma" +
            "ximum number of concurrent access licenses for this volume.\",\"format\":\"int32\"},\"" +
            ...
            "g reason code.\"},\"restricted\":{\"type\":\"boolean\",\"description\":\"Whether this volu" +
            "me has any concurrent access restrictions.\"},\"signature\":{\"type\":\"string\",\"descr" +
            "iption\":\"Response signature.\"},\"source\":{\"type\":\"string\",\"description\":\"Client a" +
            "pp identifier for verification. Download access and client-validation only.\"},\"t" +
            "imeWindowSeconds\":{\"type\":\"integer\",\"description\":\"Time in seconds for license a" +
            "uto-expiration.\",\"format\":\"int32\"},\"volumeId\":{\"type\":\"string\",\"description\":\"Id" +
            "entifies the volume for which this entry applies.\"}}},\"DownloadAccessRestriction" +
            "\":{\"id\":\"DownloadAccessRestriction\",\"type\":\"object\",\"properties\":{\"deviceAllowed" +
            "\":{\"type\":\"boolean\",\"description\":\"If restricted, whether access is granted for " +
            "this (user, device, volume).\"},\"downloadsAcquired\":{\"type\":\"integer\",\"descriptio" +
            "n\":\"If restricted, the number of content download licenses already acquired (inc" +
            "luding the requesting client, if licensed).\",\"format\":\"int32\"},\"justAcquired\":{\"" +
            "type\":\"boolean\",\"description\":\"If deviceAllowed, whether access was just acquire" +
            "d with this request.\"},\"kind\":{\"type\":\"string\",\"description\":\"Resource type.\",\"d" +
            "efault\":\"books#downloadAccessRestriction\"},\"maxDownloadDevices\":{\"type\":\"integer" +
            "\",\"description\":\"If restricted, the maximum number of content download licenses " +
            "for this volume.\",\"format\":\"int32\"},\"message\":{\"type\":\"string\",\"description\":\"Er" +
            "ror/warning message.\"},\"nonce\":{\"type\":\"string\",\"description\":\"Client nonce for " +
            "verification. Download access and client-validation only.\"},\"reasonCode\":{\"type\"" +
            ":\"string\",\"description\":\"Error/warning reason code. Additional codes may be adde" +
            "d in the future. 0 OK 100 ACCESS_DENIED_PUBLISHER_LIMIT 101 ACCESS_DENIED_LIMIT " +
            "200 WARNING_USED_LAST_ACCESS\"},\"restricted\":{\"type\":\"boolean\",\"description\":\"Whe" +
            "ther this volume has any download access restrictions.\"},\"signature\":{\"type\":\"st" +
            "ring\",\"description\":\"Response signature.\"},\"source\":{\"type\":\"string\",\"descriptio" +
            "n\":\"Client app identifier for verification. Download access and client-validatio" +
            "n only.\"},\"volumeId\":{\"type\":\"string\",\"description\":\"Identifies the volume for w" +
            "hich this entry applies.\"}}},\"DownloadAccesses\":{\"id\":\"DownloadAccesses\",\"type\":" +
            "\"object\",\"properties\":{\"downloadAccessList\":{\"type\":\"array\",\"description\":\"A lis" +
            "t of download access responses.\",\"items\":{\"$ref\":\"DownloadAccessRestriction\"}},\"" +
            "kind\":{\"type\":\"string\",\"description\":\"Resource type.\",\"default\":\"books#downloadA" +
            "ccesses\"}}},\"Layersummaries\":{\"id\":\"Layersummaries\",\"type\":\"object\",\"properties\"" +
            ":{\"items\":{\"type\":\"array\",\"description\":\"A list of layer summary items.\",\"items\"" +
            ":{\"$ref\":\"Layersummary\"}},\"kind\":{\"type\":\"string\",\"description\":\"Resource type.\"" +
            ",\"default\":\"books#layersummaries\"},\"totalItems\":{\"type\":\"integer\",\"description\":" +
            "\"The total number of layer summaries found.\",\"format\":\"int32\"}}},\"Layersummary\":" +
            "{\"id\":\"Layersummary\",\"type\":\"object\",\"properties\":{\"annotationCount\":{\"type\":\"in" +
            "teger\",\"description\":\"The number of annotations for this layer.\",\"format\":\"int32" +
            "\"},\"annotationTypes\":{\"type\":\"array\",\"description\":\"The list of annotation types" +
            " contained for this layer.\",\"items\":{\"type\":\"string\"}},\"annotationsDataLink\":{\"t" +
            "ype\":\"string\",\"description\":\"Link to get data for this annotation.\"},\"annotation" +
            "sLink\":{\"type\":\"string\",\"description\":\"The link to get the annotations for this " +
            "layer.\"},\"contentVersion\":{\"type\":\"string\",\"description\":\"The content version th" +
            "is resource is for.\"},\"dataCount\":{\"type\":\"integer\",\"description\":\"The number of" +
            " data items for this layer.\",\"format\":\"int32\"},\"id\":{\"type\":\"string\",\"descriptio" +
            "n\":\"Unique id of this layer summary.\"},\"kind\":{\"type\":\"string\",\"description\":\"Re" +
            "source Type\",\"default\":\"books#layersummary\"},\"layerId\":{\"type\":\"string\",\"descrip" +
            "tion\":\"The layer id for this summary.\"},\"selfLink\":{\"type\":\"string\",\"description" +
            "\":\"URL to this resource.\"},\"updated\":{\"type\":\"string\",\"description\":\"Timestamp f" +
            "or the last time an item in this layer was updated. (RFC 3339 UTC date-time form" +
            "at).\",\"format\":\"date-time\"},\"volumeId\":{\"type\":\"string\",\"description\":\"The volum" +
            "e id this resource is for.\"}}},\"ReadingPosition\":{\"id\":\"ReadingPosition\",\"type\":" +
            "\"object\",\"properties\":{\"epubCfiPosition\":{\"type\":\"string\",\"description\":\"Positio" +
            "n in an EPUB as a CFI.\"},\"gbImagePosition\":{\"type\":\"string\",\"description\":\"Posit" +
            "ion in a volume for image-based content.\"},\"gbTextPosition\":{\"type\":\"string\",\"de" +
            "scription\":\"Position in a volume for text-based content.\"},\"kind\":{\"type\":\"strin" +
            "g\",\"description\":\"Resource type for a reading position.\",\"default\":\"books#readin" +
            "gPosition\"},\"pdfPosition\":{\"type\":\"string\",\"description\":\"Position in a PDF file" +
            ".\"},\"updated\":{\"type\":\"string\",\"description\":\"Timestamp when this reading positi" +
            "on was last updated (formatted UTC timestamp with millisecond resolution).\",\"for" +
            "mat\":\"date-time\"},\"volumeId\":{\"type\":\"string\",\"description\":\"Volume id associate" +
            "d with this reading position.\"}}},\"RequestAccess\":{\"id\":\"RequestAccess\",\"type\":\"" +
            "object\",\"properties\":{\"concurrentAccess\":{\"$ref\":\"ConcurrentAccessRestriction\",\"" +
            "description\":\"A concurrent access response.\"},\"downloadAccess\":{\"$ref\":\"Download" +
            "AccessRestriction\",\"description\":\"A download access response.\"},\"kind\":{\"type\":\"" +
            "string\",\"description\":\"Resource type.\",\"default\":\"books#requestAccess\"}}},\"Revie" +
            "w\":{\"id\":\"Review\",\"type\":\"object\",\"properties\":{\"author\":{\"type\":\"object\",\"descr" +
            "iption\":\"Author of this review.\",\"properties\":{\"displayName\":{\"type\":\"string\",\"d" +
            "escription\":\"Name of this person.\"}}},\"content\":{\"type\":\"string\",\"description\":\"" +
            "Review text.\"},\"date\":{\"type\":\"string\",\"description\":\"Date of this review.\"},\"fu" +
            "llTextUrl\":{\"type\":\"string\",\"description\":\"URL for the full review text, for rev" +
            "iews gathered from the web.\"},\"kind\":{\"type\":\"string\",\"description\":\"Resource ty" +
            "pe for a review.\",\"default\":\"books#review\"},\"rating\":{\"type\":\"string\",\"descripti" +
            "on\":\"Star rating for this review. Possible values are ONE, TWO, THREE, FOUR, FIV" +
            "E or NOT_RATED.\"},\"source\":{\"type\":\"object\",\"description\":\"Information regarding" +
            " the source of this review, when the review is not from a Google Books user.\",\"p" +
            "roperties\":{\"description\":{\"type\":\"string\",\"description\":\"Name of the source.\"}," +
            "\"extraDescription\":{\"type\":\"string\",\"description\":\"Extra text about the source o" +
            "f the review.\"},\"url\":{\"type\":\"string\",\"description\":\"URL of the source of the r" +
            "eview.\"}}},\"title\":{\"type\":\"string\",\"description\":\"Title for this review.\"},\"typ" +
            "e\":{\"type\":\"string\",\"description\":\"Source type for this review. Possible values " +
            "are EDITORIAL, WEB_USER or GOOGLE_USER.\"},\"volumeId\":{\"type\":\"string\",\"descripti" +
            "on\":\"Volume that this review is for.\"}}},\"Volume\":{\"id\":\"Volume\",\"type\":\"object\"" +
            ",\"properties\":{\"accessInfo\":{\"type\":\"object\",\"description\":\"Any information abou" +
            "t a volume related to reading or obtaining that volume text. This information ca" +
            "n depend on country (books may be public domain in one country but not in anothe" +
            "r, e.g.).\",\"properties\":{\"accessViewStatus\":{\"type\":\"string\",\"description\":\"Comb" +
            "ines the access and viewability of this volume into a single status field for th" +
            "is user. Values can be FULL_PURCHASED, FULL_PUBLIC_DOMAIN, SAMPLE or NONE. (In L" +
            "ITE projection.)\"},\"country\":{\"type\":\"string\",\"description\":\"The two-letter ISO_" +
            "3166-1 country code for which this access information is valid. (In LITE project" +
            "ion.)\"},\"downloadAccess\":{\"$ref\":\"DownloadAccessRestriction\",\"description\":\"Info" +
            "rmation about a volume\'s download license access restrictions.\"},\"embeddable\":{\"" +
            "type\":\"boolean\",\"description\":\"Whether this volume can be embedded in a viewport" +
            " using the Embedded Viewer API.\"},\"epub\":{\"type\":\"object\",\"description\":\"Informa" +
            "tion about epub content. (In LITE projection.)\",\"properties\":{\"acsTokenLink\":{\"t" +
            "ype\":\"string\",\"description\":\"URL to retrieve ACS token for epub download. (In LI" +
            "TE projection.)\"},\"downloadLink\":{\"type\":\"string\",\"description\":\"URL to download" +
            " epub. (In LITE projection.)\"},\"isAvailable\":{\"type\":\"boolean\",\"description\":\"Is" +
            " a flowing text epub available either as public domain or for purchase. (In LITE" +
            " projection.)\"}}},\"pdf\":{\"type\":\"object\",\"description\":\"Information about pdf co" +
            "ntent. (In LITE projection.)\",\"properties\":{\"acsTokenLink\":{\"type\":\"string\",\"des" +
            "cription\":\"URL to retrieve ACS token for pdf download. (In LITE projection.)\"},\"" +
            "downloadLink\":{\"type\":\"string\",\"description\":\"URL to download pdf. (In LITE proj" +
            "ection.)\"},\"isAvailable\":{\"type\":\"boolean\",\"description\":\"Is a scanned image pdf" +
            " available either as public domain or for purchase. (In LITE projection.)\"}}},\"p" +
            "ublicDomain\":{\"type\":\"boolean\",\"description\":\"Whether or not this book is public" +
            " domain in the country listed above.\"},\"textToSpeechPermission\":{\"type\":\"string\"" +
            ",\"description\":\"Whether text-to-speech is permitted for this volume. Values can " +
            "be ALLOWED, ALLOWED_FOR_ACCESSIBILITY, or NOT_ALLOWED.\"},\"viewOrderUrl\":{\"type\":" +
            "\"string\",\"description\":\"For ordered but not yet processed orders, we give a URL " +
            "that can be used to go to the appropriate Google Wallet page.\"},\"viewability\":{\"" +
            ...
            ",\"webReaderLink\":{\"type\":\"string\",\"description\":\"URL to read this volume on the " +
            "Google Books site. Link will not allow users to read non-viewable volumes.\"}}},\"" +
            "etag\":{\"type\":\"string\",\"description\":\"Opaque identifier for a specific version o" +
            "f a volume resource. (In LITE projection)\"},\"id\":{\"type\":\"string\",\"description\":" +
            "\"Unique identifier for a volume. (In LITE projection.)\"},\"kind\":{\"type\":\"string\"" +
            ",\"description\":\"Resource type for a volume. (In LITE projection.)\",\"default\":\"bo" +
            "oks#volume\"},\"saleInfo\":{\"type\":\"object\",\"description\":\"Any information about a " +
            "volume related to the eBookstore and/or purchaseability. This information can de" +
            "pend on the country where the request originates from (i.e. books may not be for" +
            " sale in certain countries).\",\"properties\":{\"buyLink\":{\"type\":\"string\",\"descript" +
            "ion\":\"URL to purchase this volume on the Google Books site. (In LITE projection)" +
            "\"},\"country\":{\"type\":\"string\",\"description\":\"The two-letter ISO_3166-1 country c" +
            "ode for which this sale information is valid. (In LITE projection.)\"},\"isEbook\":" +
            "{\"type\":\"boolean\",\"description\":\"Whether or not this volume is an eBook (can be " +
            "added to the My eBooks shelf).\"},\"listPrice\":{\"type\":\"object\",\"description\":\"Sug" +
            "gested retail price. (In LITE projection.)\",\"properties\":{\"amount\":{\"type\":\"numb" +
            "er\",\"description\":\"Amount in the currency listed below. (In LITE projection.)\",\"" +
            "format\":\"double\"},\"currencyCode\":{\"type\":\"string\",\"description\":\"An ISO 4217, th" +
            "ree-letter currency code. (In LITE projection.)\"}}},\"onSaleDate\":{\"type\":\"string" +
            "\",\"description\":\"The date on which this book is available for sale.\",\"format\":\"d" +
            "ate-time\"},\"retailPrice\":{\"type\":\"object\",\"description\":\"The actual selling pric" +
            "e of the book. This is the same as the suggested retail or list price unless the" +
            "re are offers or discounts on this volume. (In LITE projection.)\",\"properties\":{" +
            "\"amount\":{\"type\":\"number\",\"description\":\"Amount in the currency listed below. (I" +
            "n LITE projection.)\",\"format\":\"double\"},\"currencyCode\":{\"type\":\"string\",\"descrip" +
            "tion\":\"An ISO 4217, three-letter currency code. (In LITE projection.)\"}}},\"salea" +
            "bility\":{\"type\":\"string\",\"description\":\"Whether or not this book is available fo" +
            "r sale or offered for free in the Google eBookstore for the country listed above" +
            ". Possible values are FOR_SALE, FREE, NOT_FOR_SALE, or FOR_PREORDER.\"}}},\"search" +
            "Info\":{\"type\":\"object\",\"description\":\"Search result information related to this " +
            "volume.\",\"properties\":{\"textSnippet\":{\"type\":\"string\",\"description\":\"A text snip" +
            "pet containing the search query.\"}}},\"selfLink\":{\"type\":\"string\",\"description\":\"" +
            "URL to this resource. (In LITE projection.)\"},\"userInfo\":{\"type\":\"object\",\"descr" +
            "iption\":\"User specific information related to this volume. (e.g. page this user " +
            "last read or whether they purchased this book)\",\"properties\":{\"isInMyBooks\":{\"ty" +
            "pe\":\"boolean\",\"description\":\"Whether or not this volume is currently in \\\"my boo" +
            "ks.\\\"\"},\"isPreordered\":{\"type\":\"boolean\",\"description\":\"Whether or not this volu" +
            "me was pre-ordered by the authenticated user making the request. (In LITE projec" +
            "tion.)\"},\"isPurchased\":{\"type\":\"boolean\",\"description\":\"Whether or not this volu" +
            "me was purchased by the authenticated user making the request. (In LITE projecti" +
            "on.)\"},\"readingPosition\":{\"$ref\":\"ReadingPosition\",\"description\":\"The user\'s cur" +
            "rent reading position in the volume, if one is available. (In LITE projection.)\"" +
            "},\"review\":{\"$ref\":\"Review\",\"description\":\"This user\'s review of this volume, if" +
            " one exists.\"},\"updated\":{\"type\":\"string\",\"description\":\"Timestamp when this vol" +
            "ume was last modified by a user action, such as a reading position update, volum" +
            "e purchase or writing a review. (RFC 3339 UTC date-time format).\",\"format\":\"date" +
            "-time\"}}},\"volumeInfo\":{\"type\":\"object\",\"description\":\"General volume informatio" +
            "n.\",\"properties\":{\"authors\":{\"type\":\"array\",\"description\":\"The names of the auth" +
            "ors and/or editors for this volume. (In LITE projection)\",\"items\":{\"type\":\"strin" +
            "g\"}},\"averageRating\":{\"type\":\"number\",\"description\":\"The mean review rating for " +
            "this volume. (min = 1.0, max = 5.0)\",\"format\":\"double\"},\"canonicalVolumeLink\":{\"" +
            "type\":\"string\",\"description\":\"Canonical URL for a volume. (In LITE projection.)\"" +
            ...
            "\"}}}}},\"Volumeannotation\":{\"id\":\"Volumeannotation\",\"type\":\"object\",\"properties\":" +
            "{\"annotationDataId\":{\"type\":\"string\",\"description\":\"The annotation data id for t" +
            "his volume annotation.\"},\"annotationDataLink\":{\"type\":\"string\",\"description\":\"Li" +
            "nk to get data for this annotation.\"},\"annotationType\":{\"type\":\"string\",\"descrip" +
            "tion\":\"The type of annotation this is.\"},\"contentRanges\":{\"type\":\"object\",\"descr" +
            "iption\":\"The content ranges to identify the selected text.\",\"properties\":{\"cfiRa" +
            "nge\":{\"$ref\":\"BooksAnnotationsRange\",\"description\":\"Range in CFI format for this" +
            " annotation for version above.\"},\"contentVersion\":{\"type\":\"string\",\"description\"" +
            ":\"Content version applicable to ranges below.\"},\"gbImageRange\":{\"$ref\":\"BooksAnn" +
            "otationsRange\",\"description\":\"Range in GB image format for this annotation for v" +
            "ersion above.\"},\"gbTextRange\":{\"$ref\":\"BooksAnnotationsRange\",\"description\":\"Ran" +
            "ge in GB text format for this annotation for version above.\"}}},\"data\":{\"type\":\"" +
            "string\",\"description\":\"Data for this annotation.\"},\"deleted\":{\"type\":\"boolean\",\"" +
            "description\":\"Indicates that this annotation is deleted.\"},\"id\":{\"type\":\"string\"" +
            ",\"description\":\"Unique id of this volume annotation.\"},\"kind\":{\"type\":\"string\",\"" +
            "description\":\"Resource Type\",\"default\":\"books#volumeannotation\"},\"layerId\":{\"typ" +
            "e\":\"string\",\"description\":\"The Layer this annotation is for.\"},\"pageIds\":{\"type\"" +
            ":\"array\",\"description\":\"Pages the annotation spans.\",\"items\":{\"type\":\"string\"}}," +
            "\"selectedText\":{\"type\":\"string\",\"description\":\"Excerpt from the volume.\"},\"selfL" +
            "ink\":{\"type\":\"string\",\"description\":\"URL to this resource.\"},\"updated\":{\"type\":\"" +
            "string\",\"description\":\"Timestamp for the last time this anntoation was updated. " +
            "(RFC 3339 UTC date-time format).\",\"format\":\"date-time\"},\"volumeId\":{\"type\":\"stri" +
            "ng\",\"description\":\"The Volume this annotation is for.\"}}},\"Volumeannotations\":{\"" +
            "id\":\"Volumeannotations\",\"type\":\"object\",\"properties\":{\"items\":{\"type\":\"array\",\"d" +
            "escription\":\"A list of volume annotations.\",\"items\":{\"$ref\":\"Volumeannotation\"}}" +
            ",\"kind\":{\"type\":\"string\",\"description\":\"Resource type\",\"default\":\"books#volumean" +
            "notations\"},\"nextPageToken\":{\"type\":\"string\",\"description\":\"Token to pass in for" +
            " pagination for the next page. This will not be present if this request does not" +
            " have more results.\"},\"totalItems\":{\"type\":\"integer\",\"description\":\"The total nu" +
            "mber of volume annotations found.\",\"format\":\"int32\"}}},\"Volumes\":{\"id\":\"Volumes\"" +
            ...
            "trieves metadata for a specific bookshelf for the specified user.\",\"parameters\":" +
            "{\"shelf\":{\"type\":\"string\",\"description\":\"ID of bookshelf to retrieve.\",\"required" +
            "\":true,\"location\":\"path\"},\"source\":{\"type\":\"string\",\"description\":\"String to ide" +
            "ntify the originator of this request.\",\"location\":\"query\"},\"userId\":{\"type\":\"str" +
            "ing\",\"description\":\"ID of user for whom to retrieve bookshelves.\",\"required\":tru" +
            "e,\"location\":\"path\"}},\"parameterOrder\":[\"userId\",\"shelf\"],\"response\":{\"$ref\":\"Bo" +
            "okshelf\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"book" +
            "s.bookshelves.list\",\"path\":\"users/{userId}/bookshelves\",\"httpMethod\":\"GET\",\"desc" +
            "ription\":\"Retrieves a list of public bookshelves for the specified user.\",\"param" +
            "eters\":{\"source\":{\"type\":\"string\",\"description\":\"String to identify the originat" +
            "or of this request.\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"description\"" +
            ":\"ID of user for whom to retrieve bookshelves.\",\"required\":true,\"location\":\"path" +
            "\"}},\"parameterOrder\":[\"userId\"],\"response\":{\"$ref\":\"Bookshelves\"},\"scopes\":[\"htt" +
            "ps://www.googleapis.com/auth/books\"]}},\"resources\":{\"volumes\":{\"methods\":{\"list\"" +
            ":{\"id\":\"books.bookshelves.volumes.list\",\"path\":\"users/{userId}/bookshelves/{shel" +
            "f}/volumes\",\"httpMethod\":\"GET\",\"description\":\"Retrieves volumes in a specific bo" +
            "okshelf for the specified user.\",\"parameters\":{\"maxResults\":{\"type\":\"integer\",\"d" +
            "escription\":\"Maximum number of results to return\",\"format\":\"uint32\",\"minimum\":\"0" +
            "\",\"location\":\"query\"},\"shelf\":{\"type\":\"string\",\"description\":\"ID of bookshelf to" +
            " retrieve volumes.\",\"required\":true,\"location\":\"path\"},\"showPreorders\":{\"type\":\"" +
            "boolean\",\"description\":\"Set to true to show pre-ordered books. Defaults to false" +
            ".\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to identi" +
            "fy the originator of this request.\",\"location\":\"query\"},\"startIndex\":{\"type\":\"in" +
            "teger\",\"description\":\"Index of the first element to return (starts at 0)\",\"forma" +
            "t\":\"uint32\",\"minimum\":\"0\",\"location\":\"query\"},\"userId\":{\"type\":\"string\",\"descrip" +
            "tion\":\"ID of user for whom to retrieve bookshelf volumes.\",\"required\":true,\"loca" +
            "tion\":\"path\"}},\"parameterOrder\":[\"userId\",\"shelf\"],\"response\":{\"$ref\":\"Volumes\"}" +
            ",\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}}}},\"layers\":{\"methods\":{\"g" +
            "et\":{\"id\":\"books.layers.get\",\"path\":\"volumes/{volumeId}/layersummary/{summaryId}" +
            "\",\"httpMethod\":\"GET\",\"description\":\"Gets the layer summary for a volume.\",\"param" +
            "eters\":{\"contentVersion\":{\"type\":\"string\",\"description\":\"The content version for" +
            " the requested volume.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"descripti" +
            "on\":\"String to identify the originator of this request.\",\"location\":\"query\"},\"su" +
            "mmaryId\":{\"type\":\"string\",\"description\":\"The ID for the layer to get the summary" +
            " for.\",\"required\":true,\"location\":\"path\"},\"volumeId\":{\"type\":\"string\",\"descripti" +
            "on\":\"The volume to retrieve layers for.\",\"required\":true,\"location\":\"path\"}},\"pa" +
            "rameterOrder\":[\"volumeId\",\"summaryId\"],\"response\":{\"$ref\":\"Layersummary\"},\"scope" +
            "s\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.layers.list\",\"" +
            "path\":\"volumes/{volumeId}/layersummary\",\"httpMethod\":\"GET\",\"description\":\"List t" +
            "he layer summaries for a volume.\",\"parameters\":{\"contentVersion\":{\"type\":\"string" +
            "\",\"description\":\"The content version for the requested volume.\",\"location\":\"quer" +
            "y\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"Maximum number of results to r" +
            "eturn\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"200\",\"location\":\"query\"},\"page" +
            "Token\":{\"type\":\"string\",\"description\":\"The value of the nextToken from the previ" +
            "ous page.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String t" +
            "o identify the originator of this request.\",\"location\":\"query\"},\"volumeId\":{\"typ" +
            "e\":\"string\",\"description\":\"The volume to retrieve layers for.\",\"required\":true,\"" +
            "location\":\"path\"}},\"parameterOrder\":[\"volumeId\"],\"response\":{\"$ref\":\"Layersummar" +
            "ies\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}},\"resources\":{\"annotat" +
            "ionData\":{\"methods\":{\"get\":{\"id\":\"books.layers.annotationData.get\",\"path\":\"volum" +
            "es/{volumeId}/layers/{layerId}/data/{annotationDataId}\",\"httpMethod\":\"GET\",\"desc" +
            "ription\":\"Gets the annotation data.\",\"parameters\":{\"annotationDataId\":{\"type\":\"s" +
            "tring\",\"description\":\"The ID of the annotation data to retrieve.\",\"required\":tru" +
            "e,\"location\":\"path\"},\"contentVersion\":{\"type\":\"string\",\"description\":\"The conten" +
            "t version for the volume you are trying to retrieve.\",\"required\":true,\"location\"" +
            ":\"query\"},\"h\":{\"type\":\"integer\",\"description\":\"The requested pixel height for an" +
            "y images. If height is provided width must also be provided.\",\"format\":\"int32\",\"" +
            "location\":\"query\"},\"layerId\":{\"type\":\"string\",\"description\":\"The ID for the laye" +
            "r to get the annotations.\",\"required\":true,\"location\":\"path\"},\"locale\":{\"type\":\"" +
            "string\",\"description\":\"The locale information for the data. ISO-639-1 language a" +
            "nd ISO-3166-1 country code. Ex: \'en_US\'.\",\"location\":\"query\"},\"scale\":{\"type\":\"i" +
            "nteger\",\"description\":\"The requested scale for the image.\",\"format\":\"int32\",\"min" +
            "imum\":\"0\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to" +
            " identify the originator of this request.\",\"location\":\"query\"},\"volumeId\":{\"type" +
            "\":\"string\",\"description\":\"The volume to retrieve annotations for.\",\"required\":tr" +
            "ue,\"location\":\"path\"},\"w\":{\"type\":\"integer\",\"description\":\"The requested pixel w" +
            "idth for any images. If width is provided height must also be provided.\",\"format" +
            "\":\"int32\",\"location\":\"query\"}},\"parameterOrder\":[\"volumeId\",\"layerId\",\"annotatio" +
            "nDataId\",\"contentVersion\"],\"response\":{\"$ref\":\"Annotationdata\"},\"scopes\":[\"https" +
            "://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.layers.annotationData.li" +
            "st\",\"path\":\"volumes/{volumeId}/layers/{layerId}/data\",\"httpMethod\":\"GET\",\"descri" +
            "ption\":\"Gets the annotation data for a volume and layer.\",\"parameters\":{\"annotat" +
            "ionDataId\":{\"type\":\"string\",\"description\":\"The list of Annotation Data Ids to re" +
            "trieve. Pagination is ignored if this is set.\",\"repeated\":true,\"location\":\"query" +
            "\"},\"contentVersion\":{\"type\":\"string\",\"description\":\"The content version for the " +
            "requested volume.\",\"required\":true,\"location\":\"query\"},\"h\":{\"type\":\"integer\",\"de" +
            "scription\":\"The requested pixel height for any images. If height is provided wid" +
            "th must also be provided.\",\"format\":\"int32\",\"location\":\"query\"},\"layerId\":{\"type" +
            "\":\"string\",\"description\":\"The ID for the layer to get the annotation data.\",\"req" +
            ...
            " \'en_US\'.\",\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"Max" +
            "imum number of results to return\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"200" +
            "\",\"location\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The value of t" +
            "he nextToken from the previous page.\",\"location\":\"query\"},\"scale\":{\"type\":\"integ" +
            "er\",\"description\":\"The requested scale for the image.\",\"format\":\"int32\",\"minimum" +
            "\":\"0\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to ide" +
            "ntify the originator of this request.\",\"location\":\"query\"},\"updatedMax\":{\"type\":" +
            "\"string\",\"description\":\"RFC 3339 timestamp to restrict to items updated prior to" +
            " this timestamp (exclusive).\",\"location\":\"query\"},\"updatedMin\":{\"type\":\"string\"," +
            "\"description\":\"RFC 3339 timestamp to restrict to items updated since this timest" +
            "amp (inclusive).\",\"location\":\"query\"},\"volumeId\":{\"type\":\"string\",\"description\":" +
            "\"The volume to retrieve annotation data for.\",\"required\":true,\"location\":\"path\"}" +
            ",\"w\":{\"type\":\"integer\",\"description\":\"The requested pixel width for any images. " +
            "If width is provided height must also be provided.\",\"format\":\"int32\",\"location\":" +
            "\"query\"}},\"parameterOrder\":[\"volumeId\",\"layerId\",\"contentVersion\"],\"response\":{\"" +
            "$ref\":\"Annotationsdata\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}},\"" +
            "volumeAnnotations\":{\"methods\":{\"get\":{\"id\":\"books.layers.volumeAnnotations.get\"," +
            "\"path\":\"volumes/{volumeId}/layers/{layerId}/annotations/{annotationId}\",\"httpMet" +
            "hod\":\"GET\",\"description\":\"Gets the volume annotation.\",\"parameters\":{\"annotation" +
            "Id\":{\"type\":\"string\",\"description\":\"The ID of the volume annotation to retrieve." +
            "\",\"required\":true,\"location\":\"path\"},\"layerId\":{\"type\":\"string\",\"description\":\"T" +
            "he ID for the layer to get the annotations.\",\"required\":true,\"location\":\"path\"}," +
            "\"locale\":{\"type\":\"string\",\"description\":\"The locale information for the data. IS" +
            "O-639-1 language and ISO-3166-1 country code. Ex: \'en_US\'.\",\"location\":\"query\"}," +
            "\"source\":{\"type\":\"string\",\"description\":\"String to identify the originator of th" +
            "is request.\",\"location\":\"query\"},\"volumeId\":{\"type\":\"string\",\"description\":\"The " +
            "volume to retrieve annotations for.\",\"required\":true,\"location\":\"path\"}},\"parame" +
            "terOrder\":[\"volumeId\",\"layerId\",\"annotationId\"],\"response\":{\"$ref\":\"Volumeannota" +
            "tion\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.l" +
            "ayers.volumeAnnotations.list\",\"path\":\"volumes/{volumeId}/layers/{layerId}\",\"http" +
            "Method\":\"GET\",\"description\":\"Gets the volume annotations for a volume and layer." +
            "\",\"parameters\":{\"contentVersion\":{\"type\":\"string\",\"description\":\"The content ver" +
            "sion for the requested volume.\",\"required\":true,\"location\":\"query\"},\"endOffset\":" +
            "{\"type\":\"string\",\"description\":\"The end offset to end retrieving data from.\",\"lo" +
            "cation\":\"query\"},\"endPosition\":{\"type\":\"string\",\"description\":\"The end position " +
            "to end retrieving data from.\",\"location\":\"query\"},\"layerId\":{\"type\":\"string\",\"de" +
            ...
            "on\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"Maximum number of res" +
            "ults to return\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"200\",\"location\":\"quer" +
            "y\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The value of the nextToken from " +
            "the previous page.\",\"location\":\"query\"},\"showDeleted\":{\"type\":\"boolean\",\"descrip" +
            "tion\":\"Set to true to return deleted annotations. updatedMin must be in the requ" +
            "est to use this. Defaults to false.\",\"location\":\"query\"},\"source\":{\"type\":\"strin" +
            "g\",\"description\":\"String to identify the originator of this request.\",\"location\"" +
            ":\"query\"},\"startOffset\":{\"type\":\"string\",\"description\":\"The start offset to star" +
            "t retrieving data from.\",\"location\":\"query\"},\"startPosition\":{\"type\":\"string\",\"d" +
            "escription\":\"The start position to start retrieving data from.\",\"location\":\"quer" +
            "y\"},\"updatedMax\":{\"type\":\"string\",\"description\":\"RFC 3339 timestamp to restrict " +
            "to items updated prior to this timestamp (exclusive).\",\"location\":\"query\"},\"upda" +
            "tedMin\":{\"type\":\"string\",\"description\":\"RFC 3339 timestamp to restrict to items " +
            "updated since this timestamp (inclusive).\",\"location\":\"query\"},\"volumeId\":{\"type" +
            "\":\"string\",\"description\":\"The volume to retrieve annotations for.\",\"required\":tr" +
            "ue,\"location\":\"path\"}},\"parameterOrder\":[\"volumeId\",\"layerId\",\"contentVersion\"]," +
            "\"response\":{\"$ref\":\"Volumeannotations\"},\"scopes\":[\"https://www.googleapis.com/au" +
            "th/books\"]}}}}},\"myconfig\":{\"methods\":{\"releaseDownloadAccess\":{\"id\":\"books.myco" +
            "nfig.releaseDownloadAccess\",\"path\":\"myconfig/releaseDownloadAccess\",\"httpMethod\"" +
            ":\"POST\",\"description\":\"Release downloaded content access restriction.\",\"paramete" +
            "rs\":{\"cpksver\":{\"type\":\"string\",\"description\":\"The device/version ID from which " +
            "to release the restriction.\",\"required\":true,\"location\":\"query\"},\"locale\":{\"type" +
            "\":\"string\",\"description\":\"ISO-639-1, ISO-3166-1 codes for message localization, " +
            "i.e. en_US.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String" +
            " to identify the originator of this request.\",\"location\":\"query\"},\"volumeIds\":{\"" +
            "type\":\"string\",\"description\":\"The volume(s) to release restrictions for.\",\"requi" +
            "red\":true,\"repeated\":true,\"location\":\"query\"}},\"parameterOrder\":[\"volumeIds\",\"cp" +
            "ksver\"],\"response\":{\"$ref\":\"DownloadAccesses\"},\"scopes\":[\"https://www.googleapis" +
            ".com/auth/books\"]},\"requestAccess\":{\"id\":\"books.myconfig.requestAccess\",\"path\":\"" +
            "myconfig/requestAccess\",\"httpMethod\":\"POST\",\"description\":\"Request concurrent an" +
            "d download access restrictions.\",\"parameters\":{\"cpksver\":{\"type\":\"string\",\"descr" +
            "iption\":\"The device/version ID from which to request the restrictions.\",\"require" +
            "d\":true,\"location\":\"query\"},\"locale\":{\"type\":\"string\",\"description\":\"ISO-639-1, " +
            "ISO-3166-1 codes for message localization, i.e. en_US.\",\"location\":\"query\"},\"non" +
            "ce\":{\"type\":\"string\",\"description\":\"The client nonce value.\",\"required\":true,\"lo" +
            "cation\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the" +
            " originator of this request.\",\"required\":true,\"location\":\"query\"},\"volumeId\":{\"t" +
            "ype\":\"string\",\"description\":\"The volume to request concurrent/download restricti" +
            "ons for.\",\"required\":true,\"location\":\"query\"}},\"parameterOrder\":[\"source\",\"volum" +
            "eId\",\"nonce\",\"cpksver\"],\"response\":{\"$ref\":\"RequestAccess\"},\"scopes\":[\"https://w" +
            "ww.googleapis.com/auth/books\"]},\"syncVolumeLicenses\":{\"id\":\"books.myconfig.syncV" +
            "olumeLicenses\",\"path\":\"myconfig/syncVolumeLicenses\",\"httpMethod\":\"POST\",\"descrip" +
            "tion\":\"Request downloaded content access for specified volumes on the My eBooks " +
            "shelf.\",\"parameters\":{\"cpksver\":{\"type\":\"string\",\"description\":\"The device/versi" +
            "on ID from which to release the restriction.\",\"required\":true,\"location\":\"query\"" +
            "},\"locale\":{\"type\":\"string\",\"description\":\"ISO-639-1, ISO-3166-1 codes for messa" +
            "ge localization, i.e. en_US.\",\"location\":\"query\"},\"nonce\":{\"type\":\"string\",\"desc" +
            "ription\":\"The client nonce value.\",\"required\":true,\"location\":\"query\"},\"showPreo" +
            "rders\":{\"type\":\"boolean\",\"description\":\"Set to true to show pre-ordered books. D" +
            "efaults to false.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"" +
            "String to identify the originator of this request.\",\"required\":true,\"location\":\"" +
            "query\"},\"volumeIds\":{\"type\":\"string\",\"description\":\"The volume(s) to request dow" +
            "nload restrictions for.\",\"repeated\":true,\"location\":\"query\"}},\"parameterOrder\":[" +
            "\"source\",\"nonce\",\"cpksver\"],\"response\":{\"$ref\":\"Volumes\"},\"scopes\":[\"https://www" +
            ".googleapis.com/auth/books\"]}}},\"mylibrary\":{\"resources\":{\"annotations\":{\"method" +
            "s\":{\"delete\":{\"id\":\"books.mylibrary.annotations.delete\",\"path\":\"mylibrary/annota" +
            "tions/{annotationId}\",\"httpMethod\":\"DELETE\",\"description\":\"Deletes an annotation" +
            ".\",\"parameters\":{\"annotationId\":{\"type\":\"string\",\"description\":\"The ID for the a" +
            "nnotation to delete.\",\"required\":true,\"location\":\"path\"},\"source\":{\"type\":\"strin" +
            "g\",\"description\":\"String to identify the originator of this request.\",\"location\"" +
            ":\"query\"}},\"parameterOrder\":[\"annotationId\"],\"scopes\":[\"https://www.googleapis.c" +
            "om/auth/books\"]},\"get\":{\"id\":\"books.mylibrary.annotations.get\",\"path\":\"mylibrary" +
            "/annotations/{annotationId}\",\"httpMethod\":\"GET\",\"description\":\"Gets an annotatio" +
            "n by its ID.\",\"parameters\":{\"annotationId\":{\"type\":\"string\",\"description\":\"The I" +
            "D for the annotation to retrieve.\",\"required\":true,\"location\":\"path\"},\"source\":{" +
            "\"type\":\"string\",\"description\":\"String to identify the originator of this request" +
            ".\",\"location\":\"query\"}},\"parameterOrder\":[\"annotationId\"],\"response\":{\"$ref\":\"An" +
            "notation\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"insert\":{\"id\":\"b" +
            "ooks.mylibrary.annotations.insert\",\"path\":\"mylibrary/annotations\",\"httpMethod\":\"" +
            "POST\",\"description\":\"Inserts a new annotation.\",\"parameters\":{\"source\":{\"type\":\"" +
            "string\",\"description\":\"String to identify the originator of this request.\",\"loca" +
            "tion\":\"query\"}},\"request\":{\"$ref\":\"Annotation\"},\"response\":{\"$ref\":\"Annotation\"}" +
            ",\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.mylibra" +
            "ry.annotations.list\",\"path\":\"mylibrary/annotations\",\"httpMethod\":\"GET\",\"descript" +
            "ion\":\"Retrieves a list of annotations, possibly filtered.\",\"parameters\":{\"conten" +
            "tVersion\":{\"type\":\"string\",\"description\":\"The content version for the requested " +
            "volume.\",\"location\":\"query\"},\"layerId\":{\"type\":\"string\",\"description\":\"The layer" +
            " ID to limit annotation by.\",\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\"," +
            "\"description\":\"Maximum number of results to return\",\"format\":\"uint32\",\"minimum\":" +
            "\"0\",\"maximum\":\"40\",\"location\":\"query\"},\"pageIds\":{\"type\":\"string\",\"description\":" +
            "\"The page ID(s) for the volume that is being queried.\",\"repeated\":true,\"location" +
            "\":\"query\"},\"pageToken\":{\"type\":\"string\",\"description\":\"The value of the nextToke" +
            "n from the previous page.\",\"location\":\"query\"},\"showDeleted\":{\"type\":\"boolean\",\"" +
            "description\":\"Set to true to return deleted annotations. updatedMin must be in t" +
            "he request to use this. Defaults to false.\",\"location\":\"query\"},\"source\":{\"type\"" +
            ":\"string\",\"description\":\"String to identify the originator of this request.\",\"lo" +
            "cation\":\"query\"},\"updatedMax\":{\"type\":\"string\",\"description\":\"RFC 3339 timestamp" +
            " to restrict to items updated prior to this timestamp (exclusive).\",\"location\":\"" +
            "query\"},\"updatedMin\":{\"type\":\"string\",\"description\":\"RFC 3339 timestamp to restr" +
            "ict to items updated since this timestamp (inclusive).\",\"location\":\"query\"},\"vol" +
            "umeId\":{\"type\":\"string\",\"description\":\"The volume to restrict annotations to.\",\"" +
            "location\":\"query\"}},\"response\":{\"$ref\":\"Annotations\"},\"scopes\":[\"https://www.goo" +
            "gleapis.com/auth/books\"]},\"update\":{\"id\":\"books.mylibrary.annotations.update\",\"p" +
            "ath\":\"mylibrary/annotations/{annotationId}\",\"httpMethod\":\"PUT\",\"description\":\"Up" +
            "dates an existing annotation.\",\"parameters\":{\"annotationId\":{\"type\":\"string\",\"de" +
            "scription\":\"The ID for the annotation to update.\",\"required\":true,\"location\":\"pa" +
            "th\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the originator " +
            "of this request.\",\"location\":\"query\"}},\"parameterOrder\":[\"annotationId\"],\"reques" +
            "t\":{\"$ref\":\"Annotation\"},\"response\":{\"$ref\":\"Annotation\"},\"scopes\":[\"https://www" +
            ".googleapis.com/auth/books\"]}}},\"bookshelves\":{\"methods\":{\"addVolume\":{\"id\":\"boo" +
            "ks.mylibrary.bookshelves.addVolume\",\"path\":\"mylibrary/bookshelves/{shelf}/addVol" +
            "ume\",\"httpMethod\":\"POST\",\"description\":\"Adds a volume to a bookshelf.\",\"paramete" +
            "rs\":{\"shelf\":{\"type\":\"string\",\"description\":\"ID of bookshelf to which to add a v" +
            "olume.\",\"required\":true,\"location\":\"path\"},\"source\":{\"type\":\"string\",\"descriptio" +
            "n\":\"String to identify the originator of this request.\",\"location\":\"query\"},\"vol" +
            "umeId\":{\"type\":\"string\",\"description\":\"ID of volume to add.\",\"required\":true,\"lo" +
            "cation\":\"query\"}},\"parameterOrder\":[\"shelf\",\"volumeId\"],\"scopes\":[\"https://www.g" +
            "oogleapis.com/auth/books\"]},\"clearVolumes\":{\"id\":\"books.mylibrary.bookshelves.cl" +
            "earVolumes\",\"path\":\"mylibrary/bookshelves/{shelf}/clearVolumes\",\"httpMethod\":\"PO" +
            "ST\",\"description\":\"Clears all volumes from a bookshelf.\",\"parameters\":{\"shelf\":{" +
            ...
            "hod\":\"GET\",\"description\":\"Retrieves metadata for a specific bookshelf belonging " +
            "to the authenticated user.\",\"parameters\":{\"shelf\":{\"type\":\"string\",\"description\"" +
            ":\"ID of bookshelf to retrieve.\",\"required\":true,\"location\":\"path\"},\"source\":{\"ty" +
            ...
            "\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.mylibrar" +
            "y.bookshelves.list\",\"path\":\"mylibrary/bookshelves\",\"httpMethod\":\"GET\",\"descripti" +
            "on\":\"Retrieves a list of bookshelves belonging to the authenticated user.\",\"para" +
            "meters\":{\"source\":{\"type\":\"string\",\"description\":\"String to identify the origina" +
            "tor of this request.\",\"location\":\"query\"}},\"response\":{\"$ref\":\"Bookshelves\"},\"sc" +
            "opes\":[\"https://www.googleapis.com/auth/books\"]},\"moveVolume\":{\"id\":\"books.mylib" +
            "rary.bookshelves.moveVolume\",\"path\":\"mylibrary/bookshelves/{shelf}/moveVolume\",\"" +
            "httpMethod\":\"POST\",\"description\":\"Moves a volume within a bookshelf.\",\"parameter" +
            "s\":{\"shelf\":{\"type\":\"string\",\"description\":\"ID of bookshelf with the volume.\",\"r" +
            "equired\":true,\"location\":\"path\"},\"source\":{\"type\":\"string\",\"description\":\"String" +
            " to identify the originator of this request.\",\"location\":\"query\"},\"volumeId\":{\"t" +
            "ype\":\"string\",\"description\":\"ID of volume to move.\",\"required\":true,\"location\":\"" +
            "query\"},\"volumePosition\":{\"type\":\"integer\",\"description\":\"Position on shelf to m" +
            "ove the item (0 puts the item before the current first item, 1 puts it between t" +
            "he first and the second and so on.)\",\"required\":true,\"format\":\"int32\",\"location\"" +
            ":\"query\"}},\"parameterOrder\":[\"shelf\",\"volumeId\",\"volumePosition\"],\"scopes\":[\"htt" +
            "ps://www.googleapis.com/auth/books\"]},\"removeVolume\":{\"id\":\"books.mylibrary.book" +
            "shelves.removeVolume\",\"path\":\"mylibrary/bookshelves/{shelf}/removeVolume\",\"httpM" +
            "ethod\":\"POST\",\"description\":\"Removes a volume from a bookshelf.\",\"parameters\":{\"" +
            ...
            "mes for.\",\"required\":true,\"location\":\"path\"},\"showPreorders\":{\"type\":\"boolean\",\"" +
            "description\":\"Set to true to show pre-ordered books. Defaults to false.\",\"locati" +
            ...
            "scription\":\"Index of the first element to return (starts at 0)\",\"format\":\"uint32" +
            "\",\"minimum\":\"0\",\"location\":\"query\"}},\"parameterOrder\":[\"shelf\"],\"response\":{\"$re" +
            "f\":\"Volumes\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}}}},\"readingpo" +
            "sitions\":{\"methods\":{\"get\":{\"id\":\"books.mylibrary.readingpositions.get\",\"path\":\"" +
            "mylibrary/readingpositions/{volumeId}\",\"httpMethod\":\"GET\",\"description\":\"Retriev" +
            "es my reading position information for a volume.\",\"parameters\":{\"contentVersion\"" +
            ":{\"type\":\"string\",\"description\":\"Volume content version for which this reading p" +
            "osition is requested.\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"descriptio" +
            "n\":\"String to identify the originator of this request.\",\"location\":\"query\"},\"vol" +
            "umeId\":{\"type\":\"string\",\"description\":\"ID of volume for which to retrieve a read" +
            "ing position.\",\"required\":true,\"location\":\"path\"}},\"parameterOrder\":[\"volumeId\"]" +
            ",\"response\":{\"$ref\":\"ReadingPosition\"},\"scopes\":[\"https://www.googleapis.com/aut" +
            "h/books\"]},\"setPosition\":{\"id\":\"books.mylibrary.readingpositions.setPosition\",\"p" +
            "ath\":\"mylibrary/readingpositions/{volumeId}/setPosition\",\"httpMethod\":\"POST\",\"de" +
            "scription\":\"Sets my reading position information for a volume.\",\"parameters\":{\"a" +
            "ction\":{\"type\":\"string\",\"description\":\"Action that caused this reading position " +
            "to be set.\",\"enum\":[\"bookmark\",\"chapter\",\"next-page\",\"prev-page\",\"scroll\",\"searc" +
            "h\"],\"enumDescriptions\":[\"User chose bookmark within volume.\",\"User selected chap" +
            "ter from list.\",\"Next page event.\",\"Previous page event.\",\"User navigated to pag" +
            "e.\",\"User chose search results within volume.\"],\"location\":\"query\"},\"contentVers" +
            "ion\":{\"type\":\"string\",\"description\":\"Volume content version for which this readi" +
            "ng position applies.\",\"location\":\"query\"},\"position\":{\"type\":\"string\",\"descripti" +
            "on\":\"Position string for the new volume reading position.\",\"required\":true,\"loca" +
            "tion\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"String to identify the o" +
            "riginator of this request.\",\"location\":\"query\"},\"timestamp\":{\"type\":\"string\",\"de" +
            "scription\":\"RFC 3339 UTC format timestamp associated with this reading position." +
            "\",\"required\":true,\"location\":\"query\"},\"volumeId\":{\"type\":\"string\",\"description\":" +
            "\"ID of volume for which to update the reading position.\",\"required\":true,\"locati" +
            "on\":\"path\"}},\"parameterOrder\":[\"volumeId\",\"timestamp\",\"position\"],\"scopes\":[\"htt" +
            "ps://www.googleapis.com/auth/books\"]}}}}},\"volumes\":{\"methods\":{\"get\":{\"id\":\"boo" +
            "ks.volumes.get\",\"path\":\"volumes/{volumeId}\",\"httpMethod\":\"GET\",\"description\":\"Ge" +
            "ts volume information for a single volume.\",\"parameters\":{\"country\":{\"type\":\"str" +
            "ing\",\"description\":\"ISO-3166-1 code to override the IP-based location.\",\"locatio" +
            "n\":\"query\"},\"partner\":{\"type\":\"string\",\"description\":\"Brand results for partner " +
            "ID.\",\"location\":\"query\"},\"projection\":{\"type\":\"string\",\"description\":\"Restrict i" +
            "nformation returned to a set of selected fields.\",\"enum\":[\"full\",\"lite\"],\"enumDe" +
            "scriptions\":[\"Includes all volume data.\",\"Includes a subset of fields in volumeI" +
            "nfo and accessInfo.\"],\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description" +
            "\":\"String to identify the originator of this request.\",\"location\":\"query\"},\"volu" +
            "meId\":{\"type\":\"string\",\"description\":\"ID of volume to retrieve.\",\"required\":true" +
            ",\"location\":\"path\"}},\"parameterOrder\":[\"volumeId\"],\"response\":{\"$ref\":\"Volume\"}," +
            "\"scopes\":[\"https://www.googleapis.com/auth/books\"]},\"list\":{\"id\":\"books.volumes." +
            "list\",\"path\":\"volumes\",\"httpMethod\":\"GET\",\"description\":\"Performs a book search." +
            "\",\"parameters\":{\"download\":{\"type\":\"string\",\"description\":\"Restrict to volumes b" +
            "y download availability.\",\"enum\":[\"epub\"],\"enumDescriptions\":[\"All volumes with " +
            "epub.\"],\"location\":\"query\"},\"filter\":{\"type\":\"string\",\"description\":\"Filter sear" +
            "ch results.\",\"enum\":[\"ebooks\",\"free-ebooks\",\"full\",\"paid-ebooks\",\"partial\"],\"enu" +
            "mDescriptions\":[\"All Google eBooks.\",\"Google eBook with full volume text viewabi" +
            "lity.\",\"Public can view entire volume text.\",\"Google eBook with a price.\",\"Publi" +
            "c able to see parts of text.\"],\"location\":\"query\"},\"langRestrict\":{\"type\":\"strin" +
            "g\",\"description\":\"Restrict results to books with this language code.\",\"location\"" +
            ":\"query\"},\"libraryRestrict\":{\"type\":\"string\",\"description\":\"Restrict search to t" +
            "his user\'s library.\",\"enum\":[\"my-library\",\"no-restrict\"],\"enumDescriptions\":[\"Re" +
            "strict to the user\'s library, any shelf.\",\"Do not restrict based on user\'s libra" +
            "ry.\"],\"location\":\"query\"},\"maxResults\":{\"type\":\"integer\",\"description\":\"Maximum " +
            "number of results to return.\",\"format\":\"uint32\",\"minimum\":\"0\",\"maximum\":\"40\",\"lo" +
            "cation\":\"query\"},\"orderBy\":{\"type\":\"string\",\"description\":\"Sort search results.\"" +
            ",\"enum\":[\"newest\",\"relevance\"],\"enumDescriptions\":[\"Most recently published.\",\"R" +
            "elevance to search terms.\"],\"location\":\"query\"},\"partner\":{\"type\":\"string\",\"desc" +
            "ription\":\"Restrict and brand results for partner ID.\",\"location\":\"query\"},\"print" +
            "Type\":{\"type\":\"string\",\"description\":\"Restrict to books or magazines.\",\"enum\":[\"" +
            "all\",\"books\",\"magazines\"],\"enumDescriptions\":[\"All volume content types.\",\"Just " +
            "books.\",\"Just magazines.\"],\"location\":\"query\"},\"projection\":{\"type\":\"string\",\"de" +
            "scription\":\"Restrict information returned to a set of selected fields.\",\"enum\":[" +
            "\"full\",\"lite\"],\"enumDescriptions\":[\"Includes all volume data.\",\"Includes a subse" +
            "t of fields in volumeInfo and accessInfo.\"],\"location\":\"query\"},\"q\":{\"type\":\"str" +
            "ing\",\"description\":\"Full-text search query string.\",\"required\":true,\"location\":\"" +
            "query\"},\"showPreorders\":{\"type\":\"boolean\",\"description\":\"Set to true to show boo" +
            "ks available for preorder. Defaults to false.\",\"location\":\"query\"},\"source\":{\"ty" +
            "pe\":\"string\",\"description\":\"String to identify the originator of this request.\"," +
            "\"location\":\"query\"},\"startIndex\":{\"type\":\"integer\",\"description\":\"Index of the f" +
            "irst result to return (starts at 0)\",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":" +
            "\"query\"}},\"parameterOrder\":[\"q\"],\"response\":{\"$ref\":\"Volumes\"},\"scopes\":[\"https:" +
            "//www.googleapis.com/auth/books\"]}},\"resources\":{\"associated\":{\"methods\":{\"list\"" +
            ":{\"id\":\"books.volumes.associated.list\",\"path\":\"volumes/{volumeId}/associated\",\"h" +
            "ttpMethod\":\"GET\",\"description\":\"Return a list of associated books.\",\"parameters\"" +
            ":{\"association\":{\"type\":\"string\",\"description\":\"Association type.\",\"enum\":[\"comp" +
            "lementary\"],\"enumDescriptions\":[\"Books that are complementary for additional rea" +
            "ding.\"],\"location\":\"query\"},\"filter\":{\"type\":\"string\",\"description\":\"Filter sear" +
            "ch results.\",\"enum\":[\"ebooks\",\"free-ebooks\",\"full\",\"paid-ebooks\",\"partial\"],\"enu" +
            "mDescriptions\":[\"All Google eBooks.\",\"Google eBook with full volume text viewabi" +
            "lity.\",\"Public can view entire volume text.\",\"Google eBook with a price.\",\"Publi" +
            "c able to see parts of text.\"],\"location\":\"query\"},\"maxResults\":{\"type\":\"integer" +
            "\",\"description\":\"Maximum number of results to return.\",\"format\":\"uint32\",\"minimu" +
            "m\":\"0\",\"maximum\":\"40\",\"location\":\"query\"},\"projection\":{\"type\":\"string\",\"descrip" +
            ...
            "fields in volumeInfo and accessInfo.\"],\"location\":\"query\"},\"source\":{\"type\":\"str" +
            "ing\",\"description\":\"String to identify the originator of this request.\",\"locatio" +
            "n\":\"query\"},\"startIndex\":{\"type\":\"integer\",\"description\":\"Index of the first res" +
            "ult to return (starts at 0)\",\"format\":\"uint32\",\"minimum\":\"0\",\"location\":\"query\"}" +
            ",\"volumeId\":{\"type\":\"string\",\"description\":\"ID of the source volume.\",\"required\"" +
            ":true,\"location\":\"path\"}},\"parameterOrder\":[\"volumeId\"],\"response\":{\"$ref\":\"Volu" +
            "mes\"},\"scopes\":[\"https://www.googleapis.com/auth/books\"]}}}}}}}";
    ...
    public class VolumesResource {
        ...
        public class AssociatedResource {
            ...
            public enum Association {
                ...
                /// <summary>Books that are complementary for additional reading.</summary>
                [Google.Apis.Util.StringValueAttribute("complementary")]
                Complementary,
            }
