...
namespace Google.Apis.Books.v1.Data {
    ...
    public class Annotation : Google.Apis.Requests.IDirectResponseSchema {
        ...
        /// <summary>Anchor text after excerpt. For requests, if the user bookmarked a screen that has no flowing text on it, then this field should be empty.</summary>
        ...
        /// <summary>Anchor text before excerpt. For requests, if the user bookmarked a screen that has no flowing text on it, then this field should be empty.</summary>
        ...
        public class ClientVersionRangesData {
            ...
            private BooksAnnotationsRange _imageCfiRange;
            ...
            public virtual BooksAnnotationsRange ImageCfiRange {
                get {
                    return this._imageCfiRange;
                }
                set {
                    this._imageCfiRange = value;
                }
            }
        }
    ...
    public class BooksCloudloadingResource : Google.Apis.Requests.IDirectResponseSchema {
        ...
        public virtual string ProcessingState {
            get {
    ...
    public class Volume : Google.Apis.Requests.IDirectResponseSchema {
        ...
        public class UserInfoData {
            ...
            private UserInfoData.UserUploadedVolumeInfoData _userUploadedVolumeInfo;
            ...
            public virtual System.Nullable<bool> IsUploaded {
                get {
            ...
            public virtual UserInfoData.UserUploadedVolumeInfoData UserUploadedVolumeInfo {
                get {
                    return this._userUploadedVolumeInfo;
                }
                set {
                    this._userUploadedVolumeInfo = value;
                }
            }
...
namespace Google.Apis.Books.v1 {
    ...
    public partial class BooksService : Google.Apis.Services.BaseClientService {
        ...
        public BooksService(Google.Apis.Services.BaseClientService.Initializer initializer) : 
            ...
            this._cloudloading = new CloudloadingResource(this, Authenticator);
    ...
    public class CloudloadingResource {
        ...
        public CloudloadingResource(BooksService service, Google.Apis.Authentication.IAuthenticator authenticator) {
            this.service = service;
            this.authenticator = authenticator;
        }
        ...
        /// <param name="volumeId">Required - The id of the book to be removed.</param>
        ...
        public class AddBookRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Books.v1.Data.BooksCloudloadingResource> {
            ...
            private string _drive_document_id;
            
            private string _mime_type;
            
            private string _name;
            
            private string _upload_client_token;
            ...
            public virtual string Drive_document_id {
                get {
                    return this._drive_document_id;
                }
                set {
                    this._drive_document_id = value;
                }
            }
            ...
            public virtual string Upload_client_token {
                get {
                    return this._upload_client_token;
                }
                set {
                    this._upload_client_token = value;
                }
            }
            ...
            public override string RestPath {
                get {
                    return "cloudloading/addBook";
                }
            }
            
            private void InitParameters() {
                System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter> parameters = new System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter>();
                parameters.Add("drive_document_id", Google.Apis.Util.Utilities.CreateRuntimeParameter("drive_document_id", false, "query", null, null, new string[0]));
                parameters.Add("mime_type", Google.Apis.Util.Utilities.CreateRuntimeParameter("mime_type", false, "query", null, null, new string[0]));
                parameters.Add("name", Google.Apis.Util.Utilities.CreateRuntimeParameter("name", false, "query", null, null, new string[0]));
                parameters.Add("upload_client_token", Google.Apis.Util.Utilities.CreateRuntimeParameter("upload_client_token", false, "query", null, null, new string[0]));
                this._requestParameters = new Google.Apis.Util.ReadOnlyDictionary<string, Google.Apis.Discovery.IParameter>(parameters);
            }
        }
        
        public class DeleteBookRequest : Google.Apis.Requests.ClientServiceRequest<string> {
            ...
            public override string RestPath {
                get {
                    return "cloudloading/deleteBook";
                }
            }
        ...
        public class UpdateBookRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Books.v1.Data.BooksCloudloadingResource> {
            ...
            private Google.Apis.Books.v1.Data.BooksCloudloadingResource _Body;
            ...
            public virtual Google.Apis.Books.v1.Data.BooksCloudloadingResource Body {
                get {
                    return this._Body;
                }
                set {
            ...
            public override string RestPath {
                get {
                    return "cloudloading/updateBook";
                }
            }
    ...
    public class VolumesResource {
        ...
        private MybooksResource _mybooks;
        
        private RecommendedResource _recommended;
        
        private UseruploadedResource _useruploaded;
        
        public VolumesResource(BooksService service, Google.Apis.Authentication.IAuthenticator authenticator) {
            this.service = service;
            this.authenticator = authenticator;
            this._associated = new AssociatedResource(service, authenticator);
            this._mybooks = new MybooksResource(service, authenticator);
            this._recommended = new RecommendedResource(service, authenticator);
            this._useruploaded = new UseruploadedResource(service, authenticator);
        }
        ...
        public class MybooksResource {
            ...
            private const string Resource = "volumes.mybooks";
            
            public MybooksResource(BooksService service, Google.Apis.Authentication.IAuthenticator authenticator) {
                this.service = service;
                this.authenticator = authenticator;
            }
            ...
            /// <summary>How the book was aquired</summary>
            ...
            /// <summary>The processing state of the user uploaded volumes to be returned. Applicable only if the UPLOADED is specified in the acquireMethod.</summary>
            ...
            public class ListRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Books.v1.Data.Volumes> {
                ...
                private System.Nullable<AcquireMethod> _acquireMethod;
                
                private string _locale;
                
                private System.Nullable<long> _maxResults;
                
                private System.Nullable<ProcessingState> _processingState;
                ...
                public virtual System.Nullable<AcquireMethod> AcquireMethod {
                    get {
                        return this._acquireMethod;
                    }
                    set {
                        this._acquireMethod = value;
                    }
                }
                ...
                public virtual System.Nullable<ProcessingState> ProcessingState {
                    get {
                        return this._processingState;
                    }
                    set {
                ...
                public override string RestPath {
                    get {
                        return "volumes/mybooks";
                    }
                }
                
                private void InitParameters() {
                    System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter> parameters = new System.Collections.Generic.Dictionary<string, Google.Apis.Discovery.IParameter>();
                    parameters.Add("acquireMethod", Google.Apis.Util.Utilities.CreateRuntimeParameter("acquireMethod", false, "query", null, null, new string[] {
                                    "PREORDERED",
                                    "PUBLIC_DOMAIN",
                                    "PURCHASED",
                                    "SAMPLE",
                    ...
                    parameters.Add("locale", Google.Apis.Util.Utilities.CreateRuntimeParameter("locale", false, "query", null, null, new string[0]));
                    parameters.Add("maxResults", Google.Apis.Util.Utilities.CreateRuntimeParameter("maxResults", false, "query", null, null, new string[0]));
                    parameters.Add("processingState", Google.Apis.Util.Utilities.CreateRuntimeParameter("processingState", false, "query", null, null, new string[] {
                                    "COMPLETED_FAILED",
                                    "COMPLETED_SUCCESS",
                                    "RUNNING"}));
                    parameters.Add("source", Google.Apis.Util.Utilities.CreateRuntimeParameter("source", false, "query", null, null, new string[0]));
        ...
        public class UseruploadedResource {
            ...
            private const string Resource = "volumes.useruploaded";
            
            public UseruploadedResource(BooksService service, Google.Apis.Authentication.IAuthenticator authenticator) {
                this.service = service;
                this.authenticator = authenticator;
            }
            ...
            public class ListRequest : Google.Apis.Requests.ClientServiceRequest<Google.Apis.Books.v1.Data.Volumes> {
                ...
                private Google.Apis.Util.Repeatable<string> _volumeId;
                ...
                /// <summary>The ids of the volumes to be returned. If not specified all that match the processingState are returned.</summary>
                [Google.Apis.Util.RequestParameterAttribute("volumeId", Google.Apis.Util.RequestParameterType.Query)]
                public virtual Google.Apis.Util.Repeatable<string> VolumeId {
                    get {
                        return this._volumeId;
                    }
                    set {
    ...
    public partial class BooksService {
        ...
        private CloudloadingResource _cloudloading;
